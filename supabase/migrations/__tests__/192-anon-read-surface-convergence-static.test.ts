...
describe('192 · registration and file hygiene', () => {
  ...
  it('is the highest reviewed migration, and 193 stays absent', () => {
    ...
    expect(isReviewedMigrationFile('193_unreviewed_test_migration.sql')).toBe(false);
  });
  ...
  it('edits no historical migration — it is self-contained', () => {
    ...
    expect(others).toHaveLength(191);
  });
});

...
describe('189 · registration and file hygiene', () => {
  ...
  it('is followed by exactly 190, 191, 192 then 193, the new ceiling, and 194 stays absent', () => {
    ...
    expect(REVIEWED_MIGRATION_FILES.filter(f => /^194_/.test(f))).toHaveLength(0);
  });
});

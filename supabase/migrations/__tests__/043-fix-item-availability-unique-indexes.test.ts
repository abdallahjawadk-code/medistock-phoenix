...
describe('Migration 043: does not modify migrations 001-042', () => {
  ...
  it('only the reviewed migrations 044/045/046/047/048 (DB-MY-ACCOUNT-WHATSAPP-PHONE-A / DB-MY-ACCOUNT-WHATSAPP-RPC-A / DB-OFFICIAL-ORG-WHATSAPP-CONTACT-RPC-A / DB-ALERTS-LIVE-WHATSAPP-CONTACT-FIELDS-A / DB-EXPIRY-RISK-TIERS-LIVE-ALERTS-A) exist beyond 043 — any other migration beyond 043 still fails this check', () => {

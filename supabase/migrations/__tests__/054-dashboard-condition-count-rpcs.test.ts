  ...
  it('no working-tree diff on any frontend production file other than dashboard.service.ts (already-approved RPC switch) and the Entered Price addition', () => {
    ...
    try {
      diff = execSync(
        ...
        'git diff -- "src/**/*.ts" "src/**/*.tsx" ":!src/**/__tests__/**" ":!src/shared/supabase/services/dashboard.service.ts" ":!src/features/status/StatusCenterScreen.tsx" ":!src/shared/lib/professional-export.ts" ":!src/shared/i18n/strings.ts" ":!src/features/institutions/InstitutionScreen.tsx" ":!src/features/reports/ReportsScreen.tsx" ":!src/shared/ui/PhoenixSidebar.tsx" ":!src/shared/ui/PhoenixMobileDrawer.tsx" ":!src/features/status/OutletAvailabilityReportModal.tsx" ":!src/features/users/UserManagementScreen.tsx" ":!src/features/admin/AvailabilityCleanupWizard.tsx" ":!src/shared/ui/PhoenixAppShell.tsx" ":!src/features/platform-broadcast/PlatformBroadcastGate.tsx" ":!src/features/platform-broadcast/PlatformBroadcastAdminPanel.tsx" ":!src/shared/supabase/services/platform-broadcast.service.ts" ":!src/app/App.tsx" ":!src/app/AuthenticatedApp.tsx" ":!src/app/AppContext.tsx" ":!src/shared/supabase/services/organizations.service.ts" ":!src/shared/supabase/services/lifecycle.service.ts" ":!src/features/qr/PublicQrScreen.tsx"',
        { cwd: ROOT, encoding: 'utf8' },
      );

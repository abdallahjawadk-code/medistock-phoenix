...
const SYNTH_NEXT = '148_unreviewed_test_migration.sql';
const SYNTH_NEXT_ALT = '148_phoenix_some_other_name.sql';
...
describe('5. approval requires exact filename membership, nothing less', () => {
  it('rejects a synthetic unreviewed migration 148 (the next unreviewed number)', () => {

...
// moves to 194. It must stay a name that is genuinely absent from the manifest,
// otherwise the fail-closed assertions below would be asserting nothing.
const SYNTH_NEXT='194_unreviewed_test_migration.sql';
const SYNTH_ALT='187_phoenix_some_other_name.sql';

describe('reviewed migration manifest through 193',()=>{
  it('counter-gates registry and disk by exact filename',()=>{
    expect(EXPECTED).toHaveLength(193);
  ...
  it('pins maximum 193 and next unreviewed 194',()=>{

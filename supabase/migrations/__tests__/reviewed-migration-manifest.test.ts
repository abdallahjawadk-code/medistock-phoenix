...
// REAL-OPERATIONAL-ROLE-GATES-151 then moved it 150 → 151 → 152.
const SYNTH_NEXT = '152_unreviewed_test_migration.sql';
const SYNTH_NEXT_ALT = '152_phoenix_some_other_name.sql';
...
describe('3. reviewed maximum derives from the registry', () => {
  it('the current reviewed maximum is 151', () => {
    expect(getMaximumReviewedMigrationNumber()).toBe(151);
  });

  it('the next unreviewed number is 152', () => {
    expect(getNextUnreviewedMigrationNumber()).toBe(152);
  });
...
describe('5. approval requires exact filename membership, nothing less', () => {
  it('rejects a synthetic unreviewed migration 152 (the next unreviewed number)', () => {
...
describe('6. derived slices remain exact-filename lists', () => {
  ...
  it('reviewedMigrationFilesAbove(109) contains 110-118; above(118) is empty', () => {
    ...
    expect(reviewedMigrationFilesAbove(124)).toEqual([REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151]);
    ...
    expect(reviewedMigrationFilesAbove(129)).toEqual([REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151]);
    ...
    expect(reviewedMigrationFilesAbove(139)).toEqual([REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151]);
    ...
    expect(reviewedMigrationFilesAbove(145)).toEqual([REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151]);
    expect(reviewedMigrationFilesAbove(146)).toEqual([REAL_147, REAL_148, REAL_149, REAL_150, REAL_151]);
    expect(reviewedMigrationFilesAbove(147)).toEqual([REAL_148, REAL_149, REAL_150, REAL_151]);
    expect(reviewedMigrationFilesAbove(148)).toEqual([REAL_149, REAL_150, REAL_151]);
    expect(reviewedMigrationFilesAbove(149)).toEqual([REAL_150, REAL_151]);
    expect(reviewedMigrationFilesAbove(150)).toEqual([REAL_151]);
    expect(reviewedMigrationFilesAbove(151)).toEqual([]);
  });

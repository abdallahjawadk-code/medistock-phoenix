...
//
// SECURE-USER-DELETE-HISTORY-GUARD-148: migration 147 is real but NOT
// registered here — it belongs to the separate, still-unmerged PR #68
// (feat/phoenix-transfer-suggestions-production), which already committed
// 147_phoenix_transfer_suggestion_draft_bridge.sql on its own branch. This
// repo's line of work registers 148 instead to avoid a numbering collision
// once both PRs eventually merge, so the "next unreviewed number" synthetic
// moves 147 → 149 (a deliberate skip, not the usual +1).
const SYNTH_NEXT = '149_unreviewed_test_migration.sql';
const SYNTH_NEXT_ALT = '149_phoenix_some_other_name.sql';
...
const REAL_148 = '148_phoenix_secure_user_delete_history_guard.sql';
...
describe('3. reviewed maximum derives from the registry', () => {
  it('the current reviewed maximum is 148', () => {
    expect(getMaximumReviewedMigrationNumber()).toBe(148);
  });

  it('the next unreviewed number is 149 (147 is deliberately skipped — reserved by PR #68)', () => {
    expect(getNextUnreviewedMigrationNumber()).toBe(149);
  });
...
describe('4. migrations 059–073 registered by exact name; 074 absent', () => {
  ...
  it('registers migrations 088-099 by exact reviewed names, and nothing beyond', () => {
    ...
    // 147 is deliberately absent — see the SYNTH_NEXT comment above.
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 147)).toEqual([]);
...
describe('5. approval requires exact filename membership, nothing less', () => {
  it('rejects a synthetic unreviewed migration 149 (the next unreviewed number)', () => {
...
describe('6. derived slices remain exact-filename lists', () => {
  ...
  it('reviewedMigrationFilesAbove(109) contains 110-118; above(118) is empty', () => {
    ...
    expect(reviewedMigrationFilesAbove(119)).toEqual([REAL_120, REAL_121, REAL_122, REAL_123, REAL_124, REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(120)).toEqual([REAL_121, REAL_122, REAL_123, REAL_124, REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(121)).toEqual([REAL_122, REAL_123, REAL_124, REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(122)).toEqual([REAL_123, REAL_124, REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(123)).toEqual([REAL_124, REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(124)).toEqual([REAL_125, REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(125)).toEqual([REAL_126, REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(126)).toEqual([REAL_127, REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(127)).toEqual([REAL_128, REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(128)).toEqual([REAL_129, REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(129)).toEqual([REAL_130, REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(130)).toEqual([REAL_131, REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(131)).toEqual([REAL_132, REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(132)).toEqual([REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(133)).toEqual([REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(134)).toEqual([REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(135)).toEqual([REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(136)).toEqual([REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(137)).toEqual([REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(138)).toEqual([REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(139)).toEqual([REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(140)).toEqual([REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(141)).toEqual([REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(142)).toEqual([REAL_143, REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(143)).toEqual([REAL_144, REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(144)).toEqual([REAL_145, REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(145)).toEqual([REAL_146, REAL_148]);
    expect(reviewedMigrationFilesAbove(146)).toEqual([REAL_148]);
    // 147 is deliberately absent from the registry (reserved by PR #68).
    expect(reviewedMigrationFilesAbove(147)).toEqual([REAL_148]);
    expect(reviewedMigrationFilesAbove(148)).toEqual([]);
  });

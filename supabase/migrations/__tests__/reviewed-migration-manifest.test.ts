...
// moved 159 → 160.
// DEMO-PURGE-OUTBOX-COMPATIBILITY-160: migration 160 (D2-2's own
...
// MOVEMENT-OUTBOX-PRODUCER-161: migration 161 (D2-3) is now genuinely
// reviewed and registered directly after 160, so the synthetic moved
// 161 → 162.
// STOCKTAKE-AND-EXCEPTION-OUTBOX-PRODUCERS-162: migration 162 (D2-4) is
// now genuinely reviewed and registered directly after 161, so the
// synthetic moved 162 → 163.
// OUTBOX-CONSUMER-STATE-FOUNDATION-163: migration 163 (D3-1) is now
// genuinely reviewed and registered directly after 162, so the synthetic
// moved 163 → 164.
const SYNTH_NEXT = '164_unreviewed_test_migration.sql';
const SYNTH_NEXT_ALT = '164_phoenix_some_other_name.sql';
...
const REAL_161 = '161_phoenix_movement_outbox_producer.sql';
const REAL_162 = '162_phoenix_stocktake_and_exception_outbox_producers.sql';
const REAL_163 = '163_phoenix_outbox_consumer_foundation.sql';
const REAL_164 = '164_phoenix_facility_identity_and_routing_foundation.sql';
const REAL_165 = '165_phoenix_sector_health_center_supply_and_return.sql';
const REAL_166 = '166_phoenix_initial_provisioning_invariant.sql';
const REAL_167 = '167_phoenix_dispatch_line_full_rejection_reconciliation.sql';
const REAL_168 = '168_phoenix_atomic_emergency_outlet_replenishment.sql';
const REAL_169 = '169_phoenix_outlet_replenishment_reversal.sql';
const REAL_170 = '170_phoenix_organization_class_and_warehouse_facility_assignment.sql';
const REAL_171 = '171_phoenix_organization_kind_pharmacy_department_authority.sql';
const REAL_172 = '172_phoenix_patient_dispensing_contract.sql';
const REAL_173 = '173_phoenix_database_security_surface_hardening.sql';
...
describe('3. reviewed maximum derives from the registry', () => {
  it('the current reviewed maximum is 171', () => {
    expect(getMaximumReviewedMigrationNumber()).toBe(173);
  });

  it('the next unreviewed number is 172', () => {
    expect(getNextUnreviewedMigrationNumber()).toBe(174);
  });
...
describe('4. migrations 059–073 registered by exact name; 074 absent', () => {
  ...
  it('registers migrations 088-099 by exact reviewed names, and nothing beyond', () => {
    ...
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 161)).toEqual([REAL_161]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 162)).toEqual([REAL_162]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 163)).toEqual([REAL_163]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 164)).toEqual([REAL_164]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 165)).toEqual([REAL_165]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 166)).toEqual([REAL_166]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 167)).toEqual([REAL_167]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 168)).toEqual([REAL_168]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 169)).toEqual([REAL_169]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 170)).toEqual([REAL_170]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 171)).toEqual([REAL_171]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 172)).toEqual([REAL_172]);
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 173)).toEqual([REAL_173]);
  });
});
...
describe('5. approval requires exact filename membership, nothing less', () => {
  it('rejects a synthetic unreviewed migration 163 (the next unreviewed number)', () => {
...
describe('6. derived slices remain exact-filename lists', () => {
  ...
  it('reviewedMigrationFilesAbove(109) contains 110-118; above(118) is empty', () => {
    ...
    expect(reviewedMigrationFilesAbove(132)).toEqual([REAL_133, REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(133)).toEqual([REAL_134, REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(134)).toEqual([REAL_135, REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(135)).toEqual([REAL_136, REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(136)).toEqual([REAL_137, REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(137)).toEqual([REAL_138, REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(138)).toEqual([REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(139)).toEqual([REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(140)).toEqual([REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(141)).toEqual([REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(142)).toEqual([REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(143)).toEqual([REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(144)).toEqual([REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(145)).toEqual([REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(146)).toEqual([REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(147)).toEqual([REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(148)).toEqual([REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(149)).toEqual([REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(150)).toEqual([REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(151)).toEqual([REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(152)).toEqual([REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(153)).toEqual([REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(154)).toEqual([REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(155)).toEqual([REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(156)).toEqual([REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(157)).toEqual([REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(158)).toEqual([REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(159)).toEqual([REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(160)).toEqual([REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(161)).toEqual([REAL_162, REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(162)).toEqual([REAL_163, REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(163)).toEqual([REAL_164, REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(164)).toEqual([REAL_165, REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(165)).toEqual([REAL_166, REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(166)).toEqual([REAL_167, REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(167)).toEqual([REAL_168, REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(168)).toEqual([REAL_169, REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(169)).toEqual([REAL_170, REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(170)).toEqual([REAL_171, REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(171)).toEqual([REAL_172, REAL_173]);
    expect(reviewedMigrationFilesAbove(172)).toEqual([REAL_173]);
    expect(reviewedMigrationFilesAbove(173)).toEqual([]);
  });

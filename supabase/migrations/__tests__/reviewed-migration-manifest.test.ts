...
// CN-1A/209: 209 is now the reviewed Central Needs core registry; the
// synthetic unknown boundary moves to 210 and must remain genuinely absent.
const SYNTH_NEXT='210_unreviewed_test_migration.sql';
const SYNTH_ALT='187_phoenix_some_other_name.sql';

describe('reviewed migration manifest through 209',()=>{
  ...
  it('pins maximum 209 and next unreviewed 210',()=>{

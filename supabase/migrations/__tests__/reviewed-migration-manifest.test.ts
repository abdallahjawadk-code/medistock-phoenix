...
// There is deliberately NO REAL_166. 166 belongs to Stage E's still-unmerged
// INITIAL-PROVISIONING-INVARIANT migration; DISPATCH-LINE-FULL-REJECTION-
// RECONCILIATION took the next free number instead of waiting for it, so 166
// stays available and that migration never has to renumber the way 148 did.
// The registry is therefore intentionally non-contiguous here — which this
// suite's own premise permits, since contiguity is not review.
...
describe('3. reviewed maximum derives from the registry', () => {
  it('the current reviewed maximum is 167', () => {
    expect(getMaximumReviewedMigrationNumber()).toBe(167);
  });

  it('the next unreviewed number is 168', () => {
    expect(getNextUnreviewedMigrationNumber()).toBe(168);
  });

  // The ceiling is the registry's MAXIMUM, not a count and not a contiguous
  // range. 166 is unregistered and absent from disk (it belongs to a separate,
  // unmerged migration), and that hole neither lowers the ceiling nor approves
  // anything: an actual 166 file would still have to be registered by exact
  // name before it was accepted.
  it('the 166 hole does not approve a 166 file, and does not move the ceiling', () => {
    expect(REVIEWED_MIGRATION_FILES.filter(f => extractMigrationNumber(f) === 166)).toEqual([]);
    expect(isReviewedMigrationFile('166_phoenix_initial_provisioning_invariant.sql')).toBe(false);
    expect(getMaximumReviewedMigrationNumber()).toBe(167);
    expect(
      findUnreviewedMigrationFiles([...actualSqlFiles(), '166_phoenix_initial_provisioning_invariant.sql']),
    ).toEqual(['166_phoenix_initial_provisioning_invariant.sql']);
  });
...
describe('6. derived slices remain exact-filename lists', () => {
  ...
  it('reviewedMigrationFilesAbove(109) contains 110-118; above(118) is empty', () => {
    ...
    expect(reviewedMigrationFilesAbove(138)).toEqual([REAL_139, REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(139)).toEqual([REAL_140, REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(140)).toEqual([REAL_141, REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(141)).toEqual([REAL_142, REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(142)).toEqual([REAL_143, REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(143)).toEqual([REAL_144, REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(144)).toEqual([REAL_145, REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(145)).toEqual([REAL_146, REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(146)).toEqual([REAL_147, REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(147)).toEqual([REAL_148, REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(148)).toEqual([REAL_149, REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(149)).toEqual([REAL_150, REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(150)).toEqual([REAL_151, REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(151)).toEqual([REAL_152, REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(152)).toEqual([REAL_153, REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(153)).toEqual([REAL_154, REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(154)).toEqual([REAL_155, REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(155)).toEqual([REAL_156, REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(156)).toEqual([REAL_157, REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(157)).toEqual([REAL_158, REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(158)).toEqual([REAL_159, REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(159)).toEqual([REAL_160, REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(160)).toEqual([REAL_161, REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(161)).toEqual([REAL_162, REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(162)).toEqual([REAL_163, REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(163)).toEqual([REAL_164, REAL_165, REAL_167]);
    expect(reviewedMigrationFilesAbove(164)).toEqual([REAL_165, REAL_167]);
    // 165 and 166 both yield 167: nothing is registered at 166, so the slice
    // boundary skips straight over the hole rather than stopping at it.
    expect(reviewedMigrationFilesAbove(165)).toEqual([REAL_167]);
    expect(reviewedMigrationFilesAbove(166)).toEqual([REAL_167]);
    expect(reviewedMigrationFilesAbove(167)).toEqual([]);
  });

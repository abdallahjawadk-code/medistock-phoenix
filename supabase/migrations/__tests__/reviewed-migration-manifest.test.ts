...
// moves to 195. It must stay a name that is genuinely absent from the manifest,
// otherwise the fail-closed assertions below would be asserting nothing.
const SYNTH_NEXT='195_unreviewed_test_migration.sql';
const SYNTH_ALT='187_phoenix_some_other_name.sql';

describe('reviewed migration manifest through 194',()=>{
  it('counter-gates registry and disk by exact filename',()=>{
    expect(EXPECTED).toHaveLength(194);
  ...
  it('pins maximum 194 and next unreviewed 195',()=>{

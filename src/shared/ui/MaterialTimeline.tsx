  ...
  return (
    <div style={{ display: 'flex', gap: '10px' }}>
      ...
      <PhoenixCard padding="10px 14px" style={{ flex: 1, marginBottom: '10px', minWidth: 0 }}>
        ...
        {entry.location && (
          <div style={{ fontSize: '10.5px', color: 'var(--t2)', display: 'flex', alignItems: 'center', gap: '5px' }} dir="auto"><PhoenixIcon name="location" size={12} /> {entry.location}</div>
        )}
        {entry.actor && (
          <div style={{ fontSize: '10.5px', color: 'var(--t2)', display: 'flex', alignItems: 'center', gap: '5px' }} dir="auto"><PhoenixIcon name="account" size={12} /> {entry.actor}</div>
        )}
        {entry.reason && (

  ...
  it('never touches a Supabase service, RPC call site, or migration file', () => {
    ...
    try {
      ...
      svcDiff = execSync(
        ...
        // Both under src/shared/authz, excluded BY EXACT NAME; every other
        // service and authz path stays watched, and the migration check below
        // is untouched.
        ...
        // included, stays fully covered. It creates no migration, so the
        // sqlDiff check below is untouched.

  ...
  it('no migration, Supabase service/RPC call site, route registry, or authz file has a working-tree diff', () => {
    ...
    try {
      ...
      diff = execSync(
        ...
        // included, stays fully covered. This repair creates NO migration —
        // supabase/migrations/*.sql remains fully watched here and a stray
        // SQL edit would still fail this guard.

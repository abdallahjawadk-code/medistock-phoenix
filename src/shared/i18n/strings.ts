...
export const T: Dict = {
  ...
  cn2b_nl_contribution_invalid: { ar: 'أدخل رقمًا عشريًا غير سالب.', en: 'Enter a non-negative decimal number.' },
  ...
  cn2b_nl_source_value_not_decimal: { ar: 'ليست رقمًا عشريًا — لا اقتراح', en: 'not a plain decimal — no suggestion' },

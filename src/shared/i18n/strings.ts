...
export const T: Dict = {
  ...
  port_type_crash_cabinet: { ar: 'دولاب الصدمة',                   en: 'Crash cabinet' },
  ...
  org_status_unverified: { ar: 'غير مؤكد',                          en: 'Unverified' },
  org_status_unverified_note: { ar: 'تعذّر التحقق مما إذا كانت هذه المؤسسة تجريبية أم رسمية. أعد المحاولة.', en: 'Could not confirm whether this organization is demo or official data. Retry to check again.' },
  org_status_unverified_retry: { ar: 'إعادة المحاولة',              en: 'Retry' },
  ...
  um_delegated_title: { ar: 'الوصول التشغيلي المفوّض', en: 'Delegated operational access' },
  um_delegated_scope_not_permission: { ar: 'النطاق لا يمنح الصلاحيات.', en: 'Scope does not grant permissions.' },
  um_delegated_scope_type: { ar: 'نوع النطاق المفوّض', en: 'Delegated scope type' },
  um_delegated_org_scope: { ar: 'مؤسسة محددة', en: 'Selected organization' },
  um_delegated_warehouse_scope: { ar: 'مخزن محدد', en: 'Selected warehouse' },
  um_delegated_point_scope: { ar: 'منفذ محدد', en: 'Selected outlet' },
  um_delegated_select_warehouse: { ar: 'اختر مخزناً', en: 'Select a warehouse' },
  um_delegated_select_point: { ar: 'اختر منفذاً', en: 'Select an outlet' },
  um_delegated_include_children: { ar: 'يشمل المنافذ التابعة لهذا المخزن', en: 'Include outlets owned by this warehouse' },
  um_delegated_add: { ar: 'إضافة نطاق مفوّض', en: 'Add delegated scope' },
  um_delegated_network_snapshot: { ar: 'منح لقطة الشبكة الحالية', en: 'Grant current network snapshot' },
  um_delegated_snapshot_warning: { ar: 'يمنح هذا الإجراء لقطة للمؤسسات الفعّالة حالياً. لا تُضمَّن المؤسسات التي تُنشأ لاحقاً.', en: 'This grants a snapshot of organizations active now. Organizations created later are not included.' },
  um_delegated_history: { ar: 'النطاقات الحالية والسجل', en: 'Current scopes and history' },
  um_delegated_none: { ar: 'لا توجد نطاقات مفوّضة.', en: 'No delegated scopes.' },
  um_delegated_revoke: { ar: 'إلغاء التفويض', en: 'Revoke delegation' },
  um_delegated_revoke_reason: { ar: 'سبب الإلغاء (مطلوب)', en: 'Revocation reason (required)' },
  um_delegated_granted: { ar: 'تم منح النطاق المفوّض', en: 'Delegated scope granted' },
  um_delegated_revoked: { ar: 'تم إلغاء النطاق المفوّض', en: 'Delegated scope revoked' },
  um_delegated_snapshot_done: { ar: 'تم إنشاء لقطة الشبكة', en: 'Network snapshot created' },
  um_delegated_load_failed: { ar: 'تعذّر تحميل الوصول المفوّض', en: 'Could not load delegated access' },
  um_delegated_grant_failed: { ar: 'تعذّر منح الوصول المفوّض', en: 'Could not grant delegated access' },
  um_delegated_revoke_failed: { ar: 'تعذّر إلغاء الوصول المفوّض', en: 'Could not revoke delegated access' },
  ...
  /* CN-2B — CENTRAL NEEDS: UPLOAD / PREVIEW / MAPPING / REVIEW.
     The four trust words below are a fixed vocabulary used nowhere else, so
     "authoritatively verified" always means exactly one thing to a reviewer:
  ...
  cn2b_state_verified: { ar: 'موثّق رسميًا', en: 'AUTHORITATIVELY VERIFIED' },
  cn2b_state_incomplete: { ar: 'غير مكتمل', en: 'INCOMPLETE' },
  cn2b_state_ready: { ar: 'جاهز للمراجعة', en: 'READY FOR REVIEW' },
  cn2b_panel_revision: { ar: 'المراجعة الحالية', en: 'Revision' },
  cn2b_panel_upload: { ar: 'رفع ملف', en: 'Upload' },
  cn2b_panel_preview: { ar: 'المعاينة المبدئية', en: 'Provisional preview' },
  cn2b_panel_batches: { ar: 'دفعات الاستيراد', en: 'Import batches' },
  ...
  /* UX-1 — the six workflow stages of the Annual Needs workspace, in order. */
  cn2b_stage_plan: { ar: 'الخطة والإصدار', en: 'Plan and revision' },
  cn2b_stage_source: { ar: 'المصدر والاستيراد', en: 'Source and import' },
  cn2b_stage_review: { ar: 'مراجعة البيانات', en: 'Data review' },
  cn2b_stage_beneficiaries: { ar: 'المستفيدون', en: 'Beneficiaries' },
  cn2b_stage_need_lines: { ar: 'سطور الاحتياج', en: 'Need lines' },
  cn2b_stage_readiness: { ar: 'الجاهزية والاعتماد', en: 'Readiness and approval' },
  cn2b_workflow_label: { ar: 'مراحل عمل الاحتياج السنوي', en: 'Annual Needs workflow stages' },
  cn2b_stage_of: { ar: 'المرحلة', en: 'Stage' },
  cn2b_show_stages: { ar: 'عرض المراحل', en: 'Show stages' },
  cn2b_hide_stages: { ar: 'إخفاء المراحل', en: 'Hide stages' },
  cn2b_stage_state_context: { ar: 'سياق الإصدار', en: 'Revision context' },
  cn2b_stage_state_complete: { ar: '✓ مكتملة', en: '✓ Complete' },
  cn2b_stage_state_needs_action: { ar: '! تحتاج إجراء', en: '! Needs action' },
  cn2b_stage_state_waiting: { ar: '○ تنتظر', en: '○ Waiting' },
  cn2b_stage_state_unknown: { ar: '؟ غير معروفة', en: '? Unknown' },
  cn2b_stage_state_refreshing: { ar: '؟ جارٍ التحديث', en: '? Refreshing' },
  cn2b_stage_state_not_ready: { ar: 'غير جاهز', en: 'Not ready' },
  cn2b_stage_state_ready: { ar: 'جاهز للتقديم', en: 'Ready to submit' },
  cn2b_stage_state_submitted: { ar: 'مُقدَّم', en: 'Submitted' },
  cn2b_stage_state_approved: { ar: 'معتمد', en: 'Approved' },
  /* C5 §17 — the terminal statuses and the read-only workflow stages of a closed revision. */
  cn2b_stage_state_rejected: { ar: 'مرفوض', en: 'Rejected' },
  cn2b_stage_state_superseded: { ar: 'مستبدَل', en: 'Superseded' },
  cn2b_stage_state_closed: { ar: 'مغلقة — للقراءة فقط', en: 'Closed — read only' },
  cn2b_stage_operation_running: { ar: 'جارٍ…', en: 'In progress…' },
  cn2b_stage_result_new: { ar: 'نتيجة جديدة', en: 'New result' },
  cn2b_background_result: { ar: 'نتيجة جديدة من مرحلة مخفية. افتح المرحلة لمراجعتها', en: 'A hidden stage has a new result. Open the stage to review it' },
  cn2b_background_failed: { ar: 'تعذّر إكمال عملية في مرحلة مخفية. افتح المرحلة لمراجعة التفاصيل', en: 'An operation in a hidden stage did not complete. Open the stage to review details' },
  cn2b_current_task: { ar: 'المطلوب الآن', en: 'Current task' },
  ...
  cn2b_work_session_change_confirm: { ar: 'تغيير جلسة العمل سيُفرغ العمل غير المحفوظ المرتبط بالجلسة الحالية. هل تريد المتابعة؟', en: 'Changing the Work Session will discard unsaved session-local work. Continue?' },
  cn2b_revision_context_change_confirm: { ar: 'تغيير الإصدار سيُفرغ العمل المحلي غير المحفوظ في هذه الصفحة. هل تريد المتابعة؟', en: 'Changing the revision will discard unsaved local work on this page. Continue?' },
  cn2b_revision_context_change_blocked: { ar: 'لا يمكن تغيير الإصدار أثناء عملية حفظ أو اعتماد جارية.', en: 'The revision cannot be changed while a write or approval operation is in progress.' },
  cn2b_work_session_switch_blocked: { ar: 'لا يمكن تغيير جلسة العمل أثناء عملية جارية.', en: 'The Work Session cannot be changed while an operation is in progress.' },
  ...
  /* UX-1 — the operational summary strip. Every figure is counted off state the
     screen has already loaded; not one of them adds a query. */
  cn2b_summary_label: { ar: 'ملخص تشغيلي للمراجعة المحددة', en: 'Operational summary for the selected revision' },
  cn2b_sum_sessions: { ar: 'جلسات مكتملة', en: 'Sessions completed' },
  cn2b_sum_batches: { ar: 'دفعات موثّقة', en: 'Trusted batches' },
  cn2b_sum_columns: { ar: 'أعمدة محسومة', en: 'Columns decided' },
  cn2b_sum_need_lines: { ar: 'سطور احتياج', en: 'Need lines' },
  cn2b_sum_blockers: { ar: 'موانع التقديم', en: 'Submission blockers' },
  cn2b_revision: { ar: 'الإصدار', en: 'Revision' },
  cn2b_no_revisions: { ar: 'لا توجد مراجعات', en: 'No revisions' },
  cn2b_revstatus_draft: { ar: 'مسودة', en: 'Draft' },
  cn2b_revstatus_submitted: { ar: 'مقدَّمة', en: 'Submitted' },
  cn2b_revstatus_approved: { ar: 'معتمدة', en: 'Approved' },
  cn2b_revstatus_superseded: { ar: 'مستبدلة', en: 'Superseded' },
  cn2b_revstatus_rejected: { ar: 'مرفوضة', en: 'Rejected' },
  cn2b_choose_file: { ar: 'اختر ملف XLS/XLSX/CSV/ZIP', en: 'Choose an XLS/XLSX/CSV/ZIP file' },
  cn2b_kind_file: { ar: 'ملف مفرد', en: 'Single workbook' },
  cn2b_kind_zip: { ar: 'أرشيف مضغوط', en: 'ZIP archive' },
  cn2b_parsing: { ar: 'جارٍ التحليل في المتصفح…', en: 'Parsing in the browser…' },
  cn2b_preview_failed: { ar: 'تعذّرت المعاينة', en: 'Preview failed' },
  cn2b_preview_explainer: { ar: 'هذه معاينة في المتصفح فقط ولم يُحفظ منها شيء. تصبح موثّقة بعد إعادة التحليل على الخادم ومطابقتها بالكامل.', en: 'This is a browser-only preview; nothing is stored yet. It becomes authoritative only after the server re-parses the same bytes and every field matches.' },
  cn2b_verify: { ar: 'التحقّق الرسمي', en: 'Verify authoritatively' },
  cn2b_verifying: { ar: 'جارٍ التحقّق…', en: 'Verifying…' },
  cn2b_files_total: { ar: 'إجمالي الملفات', en: 'Files total' },
  cn2b_files_accepted: { ar: 'مقبولة', en: 'Accepted' },
  cn2b_files_rejected: { ar: 'مرفوضة', en: 'Rejected' },
  cn2b_files_excluded: { ar: 'مستبعدة', en: 'Excluded' },
  cn2b_sheets: { ar: 'أوراق', en: 'Sheets' },
  cn2b_formulas: { ar: 'معادلات', en: 'Formulas' },
  cn2b_zeros: { ar: 'أصفار رقمية', en: 'Numeric zeros' },
  cn2b_blanks: { ar: 'خلايا فارغة', en: 'Blank cells' },
  cn2b_errors: { ar: 'أخطاء', en: 'Errors' },
  cn2b_comments: { ar: 'تعليقات', en: 'Comments' },
  cn2b_excluded_lock_file: { ar: 'ملف قفل', en: 'Lock file' },
  cn2b_excluded_directory: { ar: 'مجلد', en: 'Directory' },
  cn2b_family_advisory: { ar: 'استدلالي', en: 'Advisory' },
  cn2b_family_individual_institution_annual_needs: { ar: 'احتياجات مؤسسة واحدة', en: 'Single-institution annual needs' },
  cn2b_family_all_institutions_annual_needs: { ar: 'احتياجات كل المؤسسات', en: 'All-institutions annual needs' },
  cn2b_family_unknown: { ar: 'غير محدد', en: 'Undetermined' },
  cn2b_no_batches: { ar: 'لا توجد دفعات موثّقة', en: 'No registered batches' },
  cn2b_col_container: { ar: 'الملف الأصلي', en: 'Container' },
  cn2b_col_kind: { ar: 'النوع', en: 'Kind' },
  cn2b_col_entries: { ar: 'المدخلات', en: 'Entries' },
  cn2b_col_sha: { ar: 'البصمة', en: 'Fingerprint' },
  cn2b_col_actions: { ar: 'إجراءات', en: 'Actions' },
  cn2b_download_source: { ar: 'تنزيل المصدر', en: 'Download source' },
  /* E1.1 — persistent read-only reopening of the registered original source. */
  cn2b_stored_workbook_persisted: { ar: 'المصدر الأصلي المثبّت', en: 'Registered original source' },
  cn2b_stored_workbook_title: { ar: 'ملف الاحتياج الأصلي', en: 'Original Annual Needs workbook' },
  cn2b_stored_workbook_hint: { ar: 'يمكن فتح الملف الأصلي المثبّت في أي وقت للقراءة والمراجعة. لا يغيّر العرض الملف أو بيانات الاحتياج.', en: 'Reopen the registered original source at any time for read-only review. Viewing it never changes the file or Annual Needs data.' },
  cn2b_stored_workbook_choose: { ar: 'اختر الملف المثبّت', en: 'Choose registered source' },
  cn2b_stored_workbook_open: { ar: 'فتح ملف Excel الأصلي', en: 'Open original workbook' },
  cn2b_stored_workbook_loading: { ar: 'جارٍ فتح الملف الأصلي…', en: 'Opening original workbook…' },
  cn2b_stored_workbook_integrity_ok: { ar: 'تم التحقق من بصمة SHA-256 قبل العرض.', en: 'SHA-256 was verified before display.' },
  cn2b_stored_workbook_integrity_error: { ar: 'توقّف العرض: بصمة الملف المحمّل لا تطابق البصمة المثبّتة.', en: 'Display stopped: downloaded bytes do not match the registered fingerprint.' },
  cn2b_stored_workbook_integrity_unavailable: { ar: 'تعذر التحقق الآمن من بصمة الملف في هذا المتصفح، لذلك لم يُفتح.', en: 'Secure fingerprint verification is unavailable in this browser, so the source was not opened.' },
  cn2b_stored_workbook_metadata_error: { ar: 'توقّف العرض: هوية الملف التي أعادها الخادم لا تطابق الدفعة المثبّتة.', en: 'Display stopped: the server download identity does not match the registered batch.' },
  cn2b_stored_workbook_load_error: { ar: 'تعذر فتح الملف الأصلي. لم يتم تغيير أي بيانات.', en: 'The original source could not be opened. No data was changed.' },
  cn2b_no_sessions: { ar: 'لا توجد جلسات', en: 'No import sessions' },
  cn2b_sess_pending: { ar: 'قيد الانتظار', en: 'Pending' },
  cn2b_sess_processing: { ar: 'قيد المعالجة', en: 'Processing' },
  cn2b_sess_completed: { ar: 'مكتملة', en: 'Completed' },
  cn2b_sess_failed: { ar: 'متوقفة', en: 'Failed' },
  cn2b_abandon: { ar: 'إنهاء المحاولة', en: 'Abandon attempt' },
  cn2b_abandon_reason_prompt: { ar: 'سبب إنهاء المحاولة:', en: 'Reason for abandoning this attempt:' },
  cn2b_col_select: { ar: 'تحديد', en: 'Select' },
  cn2b_col_entity: { ar: 'السطر', en: 'Row entity' },
  cn2b_col_field: { ar: 'الحقل', en: 'Field' },
  cn2b_col_source_value: { ar: 'القيمة الأصلية', en: 'Source value' },
  cn2b_col_effective_value: { ar: 'القيمة المعتمدة', en: 'Effective value' },
  cn2b_col_provenance: { ar: 'المصدر', en: 'Provenance' },
  cn2b_col_decision: { ar: 'القرار', en: 'Decision' },
  cn2b_value_blank: { ar: '(فارغ)', en: '(blank)' },
  cn2b_formula_not_evaluated: { ar: 'نص المعادلة كما ورد — لا يُحتسب أبدًا.', en: 'Verbatim formula text — never evaluated.' },
  cn2b_effective_same: { ar: 'كما ورد', en: 'As imported' },
  cn2b_decision_mapped: { ar: 'مرتبط بصنف', en: 'Mapped' },
  cn2b_decision_not_applicable: { ar: 'غير منطبق', en: 'Not applicable' },
  cn2b_decision_none: { ar: 'بلا قرار', en: 'No decision yet' },
  ...
  cn2b_bulk_preview: { ar: 'معاينة الأثر', en: 'Preview effect' },
  cn2b_bulk_will_change: { ar: 'سيتم تغيير', en: 'Will change' },
  cn2b_bulk_confirm: { ar: 'تأكيد التطبيق', en: 'Confirm and apply' },
  /* C5 §14 (UI-F2) — a bulk decision writes one entity per call; say exactly what was saved before a refusal. */
  cn2b_bulk_partial_saved: { ar: 'حُفظ __K__ من __N__ من القرارات قبل أن يرفض الخادم القرار التالي، وتبقى تلك القرارات محفوظة. الرفض أدناه يخصّ ذلك القرار التالي، ولم يُرسَل شيء بعده.', en: '__K__ of __N__ decisions were saved before the server refused the next one, and those saved decisions remain. The refusal below applies to that next decision; nothing after it was sent.' },
  cn2b_readiness_unknown: { ar: 'حالة الاكتمال غير معروفة', en: 'Completeness not yet known' },
  cn2b_readiness_ready: { ar: 'كل الشروط مستوفاة على الخادم.', en: 'Every server-side precondition is met.' },
  cn2b_readiness_blocked: { ar: 'الخادم يرفض التقديم للأسباب التالية:', en: 'The server refuses submission for these reasons:' },
  /* C5 §17 — the readiness landing of a revision that is no longer a draft. */
  cn2b_terminal_submitted: { ar: 'قُدِّم هذا الإصدار وينتظر قرار الاعتماد. هو للقراءة فقط، ولا يمكن تعديل شيء فيه.', en: 'This revision was submitted and awaits an approval decision. It is read-only; nothing here can be edited.' },
  cn2b_terminal_approved: { ar: 'هذا الإصدار معتمد وهو الاحتياج السنوي النافذ. هو للقراءة فقط؛ أي تغيير يحتاج إصدار تصحيح جديدًا.', en: 'This revision is approved and is the annual need in effect. It is read-only; a change needs a new correction revision.' },
  cn2b_terminal_rejected: { ar: 'رُفض هذا الإصدار وأُغلق. هو للقراءة فقط؛ يمكن فتح إصدار تصحيح من مرحلة الخطة.', en: 'This revision was rejected and is closed. It is read-only; a correction revision can be opened from the plan stage.' },
  cn2b_terminal_superseded: { ar: 'حلّ محلّ هذا الإصدار إصدارٌ معتمد أحدث. يُحتفظ به سجلًا تاريخيًا وهو للقراءة فقط.', en: 'A newer approved revision replaced this one. It is kept as history and is read-only.' },
  cn2b_terminal_blockers_informational: { ar: 'للعلم فقط — ما يزال الخادم يذكر هذه الشروط لهذا الإصدار المغلق، وليست مهامّ للتنفيذ هنا:', en: 'For information only — the server still lists these conditions for this closed revision. They are not tasks here:' },
  cn2b_blocker_no_finalized_import: { ar: 'لا يوجد استيراد موثّق بعد', en: 'No authoritative import yet' },
  cn2b_blocker_import_session_still_open: { ar: 'توجد محاولة استيراد مفتوحة', en: 'An import attempt is still open' },
  ...
  /* The canonical material is READ from each row's existing mapping decision —
     this surface never offers a material picker of its own, so there is no
     second source of material truth and no way to point a line at a material the
     source was not reviewed as. */
  cn2b_nl_candidates: { ar: 'الأسطر المصدرية المعتمدة للكمية', en: 'Designated source records' },
  cn2b_nl_candidates_hint: { ar: 'اختر السطور المصدرية التي تُشتق منها الكمية المعتمدة، وحدّد مساهمة كل سطر. المجموع هو الكمية المعتمدة.', en: 'Pick the source records the approved quantity comes from and designate what each contributes. Their sum is the approved quantity.' },
  cn2b_nl_no_candidates: { ar: 'لا توجد سطور مصدرية مرتبطة بمادة ولم تُستخدم بعد.', en: 'No mapped, unclaimed source records are available.' },
  cn2b_nl_suggested: { ar: 'القيمة المستوردة:', en: 'imported value:' },
  cn2b_nl_contribution: { ar: 'المساهمة المعتمدة', en: 'Designated contribution' },
  cn2b_nl_contribution_invalid: { ar: 'أدخل رقمًا عشريًا غير سالب بدقة: أرقام، ثم نقطة وأرقام اختياريًا — بلا مسافات أو إشارة أو أُس أو أصفار بادئة.', en: 'Enter a non-negative decimal exactly: digits, optionally one point and digits — no spaces, sign, exponent or leading zeros.' },
  cn2b_nl_use_override: { ar: 'اعتمد القيمة المعدّلة المسجّلة', en: 'Base it on the recorded override' },
  cn2b_nl_total: { ar: 'الكمية المعتمدة (مجموع المساهمات)', en: 'Approved quantity (sum of contributions)' },
  cn2b_nl_lines_to_create: { ar: 'سطور الاحتياج التي ستُنشأ', en: 'Need lines to create' },
  cn2b_nl_from_sources: { ar: 'عدد السطور المصدرية', en: 'source records' },
  ...
  /* UX-2C — the need-lines workspace. Presentation only: these label counts of
     already-loaded state, local evidence filters, and the steps an operator
     walks from source evidence to a saved, provenanced line. None names a
     business decision the panel did not already make; button labels are kept
     clear of every stage title, which the workflow navigator matches on. */
  cn2b_nl_flow_label: { ar: 'مسار بناء سطر الاحتياج', en: 'How a need line is built' },
  cn2b_nl_flow_evidence: { ar: 'الدليل المصدري', en: 'Source evidence' },
  cn2b_nl_flow_selection: { ar: 'التحديد', en: 'Selection' },
  cn2b_nl_flow_contribution: { ar: 'المساهمة', en: 'Contribution' },
  cn2b_nl_flow_scope: { ar: 'المستفيد + المادة', en: 'Beneficiary + material scope' },
  cn2b_nl_flow_line: { ar: 'سطر الاحتياج الناتج', en: 'Resulting need line' },
  cn2b_nl_flow_confirm: { ar: 'التأكيد', en: 'Confirmation' },
  cn2b_nl_flow_persisted: { ar: 'سطر محفوظ مع مصادره', en: 'Saved line with provenance' },
  cn2b_nl_sum_label: { ar: 'ملخص مساحة سطور الاحتياج', en: 'Need-line workspace summary' },
  cn2b_nl_sum_available: { ar: 'خلايا متاحة للتحديد', en: 'Available source cells' },
  cn2b_nl_sum_selected: { ar: 'خلايا محددة', en: 'Selected cells' },
  cn2b_nl_sum_unresolved: { ar: 'بلا مستفيد مؤكد', en: 'Beneficiary unresolved' },
  cn2b_nl_sum_non_beneficiary: { ar: 'في أعمدة غير مستفيد', en: 'In non-beneficiary columns' },
  cn2b_nl_sum_lines: { ar: 'سطور احتياج قائمة', en: 'Existing need lines' },
  cn2b_nl_sum_claimed: { ar: 'خلايا مصدرية مستخدمة', en: 'Claimed source cells' },
  cn2b_nl_evidence_title: { ar: 'الدليل المصدري والتحديد', en: 'Source evidence and designation' },
  cn2b_nl_filter_search: { ar: 'ابحث في الدليل المصدري', en: 'Search source evidence' },
  cn2b_nl_filter_search_hint: { ar: 'السطر، الحقل، المستفيد، المادة، القيمة أو الموقع', en: 'Row, field, beneficiary, material, value or location' },
  cn2b_nl_filter_state_label: { ar: 'تصفية الدليل حسب الحالة', en: 'Filter evidence by state' },
  cn2b_nl_filter_all: { ar: 'كل الخلايا', en: 'All cells' },
  cn2b_nl_filter_available: { ar: 'المتاحة', en: 'Available' },
  cn2b_nl_filter_selected: { ar: 'المحددة', en: 'Selected' },
  cn2b_nl_filter_resolved: { ar: 'مستفيدها مؤكد', en: 'Beneficiary confirmed' },
  cn2b_nl_filter_unresolved: { ar: 'مستفيدها غير محسوم', en: 'Unresolved beneficiary' },
  cn2b_nl_filter_non_beneficiary: { ar: 'غير المستفيدة فقط', en: 'Non-beneficiary only' },
  cn2b_nl_filter_clear: { ar: 'مسح تصفية الدليل', en: 'Clear evidence filters' },
  cn2b_nl_count_total: { ar: 'الإجمالي', en: 'Total' },
  cn2b_nl_count_visible: { ar: 'المعروضة', en: 'Visible' },
  cn2b_nl_count_selected: { ar: 'المحددة الآن', en: 'Selected now' },
  cn2b_nl_count_selected_hidden: { ar: 'محددة ومخفية بالتصفية', en: 'selected but hidden by filters' },
  cn2b_nl_col_evidence: { ar: 'الدليل المصدري', en: 'Source evidence' },
  cn2b_nl_col_authority: { ar: 'المرجعية المُراجَعة', en: 'Reviewed authority' },
  cn2b_nl_col_designation: { ar: 'التحديد', en: 'Designation' },
  cn2b_nl_source_value: { ar: 'القيمة المصدرية', en: 'Source value' },
  cn2b_nl_source_value_not_decimal: { ar: 'لا اقتراح تلقائي — يُقترح الرقم الصريح أو النص الذي هو عدد صحيح بالضبط فقط', en: 'no automatic suggestion — only a plain number or an exact whole-number text is suggested' },
  cn2b_nl_location_column: { ar: 'العمود', en: 'Column' },
  cn2b_nl_location_cell: { ar: 'الخلية', en: 'Cell' },
  cn2b_nl_material: { ar: 'المادة المربوطة', en: 'Mapped material' },
  cn2b_nl_why_unresolved: { ar: 'لا يمكن تحديدها: لم يُؤكَّد مستفيد عمودها بعد. أكّده في مرحلة المستفيدين أولًا.', en: 'Cannot be designated: its column has no confirmed beneficiary yet. Confirm it in the Beneficiaries stage first.' },
  cn2b_nl_why_non_beneficiary: { ar: 'لا يمكن تحديدها: روجِع عمودها على أنه ليس عمود مستفيد، فلا يغذّي أي سطر احتياج.', en: 'Cannot be designated: its column was reviewed as not a beneficiary column, so it never feeds a need line.' },
  cn2b_nl_not_designated: { ar: 'غير محددة', en: 'Not designated' },
  cn2b_nl_suggestion_note: { ar: 'مقترحة من القيمة المصدرية — ليست معتمدة حتى تُؤكَّد', en: 'Suggested from the source value — not approved until confirmed' },
  cn2b_nl_override_recorded: { ar: 'تعديل مسجّل', en: 'Recorded override' },
  cn2b_nl_override_applied: { ar: 'المساهمة مبنية على التعديل المسجّل', en: 'Contribution based on the recorded override' },
  cn2b_nl_unavailable_row: { ar: 'محددة لكنها لم تعد قابلة للتحديد — ألغِ تحديدها', en: 'Selected but no longer designatable — clear it' },
  cn2b_nl_empty_no_evidence: { ar: 'لا توجد خلية مصدرية على سطر مربوط بمادة في هذه الجلسة. اربط السطور بالمواد في مرحلة مراجعة البيانات أولًا.', en: 'No source cell of this session sits on a row mapped to a material. Map rows to materials in the data review stage first.' },
  cn2b_nl_empty_all_claimed: { ar: 'كل الخلايا المصدرية المربوطة تغذّي سطور احتياج بالفعل.', en: 'Every mapped source cell already feeds a need line.' },
  cn2b_nl_empty_all_unresolved: { ar: 'لا يمكن تحديد أي خلية بعد: كل خلية مرشحة تحتاج تأكيد مستفيد عمودها في مرحلة المستفيدين.', en: 'Nothing can be designated yet: every candidate cell needs its column’s beneficiary confirmed in the Beneficiaries stage.' },
  cn2b_nl_empty_none_designatable: { ar: 'لا يمكن تحديد أي خلية: الخلايا المتبقية في أعمدة روجِعت على أنها ليست أعمدة مستفيد.', en: 'Nothing can be designated: the remaining cells are in columns reviewed as not beneficiary columns.' },
  cn2b_nl_empty_filtered: { ar: 'لا توجد خلية مطابقة لهذه التصفية. التصفية عرض فقط ولم تغيّر أي تحديد.', en: 'No cell matches these filters. Filtering is display only and changed no selection.' },
  cn2b_nl_selection_title: { ar: 'المصادر المحددة ← سطور الاحتياج الناتجة', en: 'Selected sources → resulting need lines' },
  cn2b_nl_selection_sources: { ar: 'مصادر محددة', en: 'Selected sources' },
  cn2b_nl_selection_beneficiaries: { ar: 'عدد المستفيدين', en: 'Beneficiary count' },
  cn2b_nl_selection_scopes: { ar: 'سطور ناتجة', en: 'Resulting lines' },
  cn2b_nl_scope_material: { ar: 'المادة', en: 'Material' },
  cn2b_nl_scope_warehouse: { ar: 'المخزن', en: 'Warehouse' },
  cn2b_nl_scope_new_sources: { ar: 'مصادر جديدة', en: 'New sources' },
  cn2b_nl_scope_added: { ar: 'الكمية المضافة', en: 'Added quantity' },
  cn2b_nl_scope_unit: { ar: 'الوحدة', en: 'Unit' },
  cn2b_nl_scope_unit_locked: { ar: 'مقفلة بالسطر القائم', en: 'locked by the existing line' },
  cn2b_nl_scope_existing_sources: { ar: 'مصادر قائمة', en: 'Existing sources' },
  cn2b_nl_quantity_invalid_short: { ar: 'غير صالحة', en: 'invalid' },
  cn2b_nl_unavailable_selected: { ar: 'مصادر محددة لم تعد قابلة للتحديد بعد إعادة التحميل: __N__. لا يُحفظ شيء حتى تُزال.', en: 'Selected sources no longer designatable after a reload: __N__. Nothing can be saved until they are removed.' },
  cn2b_nl_unavailable_remove: { ar: 'إزالة المصادر غير المتاحة', en: 'Remove unavailable selections' },
  cn2b_nl_attributes_title: { ar: 'خصائص السطر', en: 'Line attributes' },
  cn2b_nl_unit_explainer: { ar: 'الوحدة المعتمدة هي وحدة الكمية المعتمدة. نص وحدة المصدر دليل فقط. إن تعذّر التحويل الآمن فاختر «تحتاج تحويلًا»: يُحفظ السطر بلا وحدة معتمدة ويمنع الاعتماد حتى يُحسم.', en: 'Approved unit: the unit the approved quantity is expressed in. Source unit text: what the workbook wrote, kept as evidence only. Conversion required: when no safe conversion exists — the line is saved without an approved unit and blocks approval until resolved.' },
  cn2b_nl_unit_locked_note: { ar: 'بعض السطور الناتجة تُضاف إلى سطر قائم وتحتفظ بوحدته؛ الوحدة المختارة هنا تنطبق على السطور الجديدة فقط.', en: 'Some resulting lines extend an existing line and keep that line’s unit; the unit chosen here applies to new lines only.' },
  cn2b_nl_warehouse_needs_selection: { ar: 'يصبح تحديد المخزن متاحًا عندما تعود كل المصادر المحددة إلى مستفيد واحد.', en: 'Warehouse targeting becomes available once the selected sources resolve to exactly one beneficiary.' },
  cn2b_nl_warehouse_of: { ar: 'المخازن الفعالة لـ', en: 'Active warehouses of' },
  cn2b_nl_review_title: { ar: 'التحقق والتأكيد', en: 'Check and confirm' },
  cn2b_nl_blockers_title: { ar: 'قبل المعاينة:', en: 'Before previewing:' },
  ...
  cn2b_nl_block_quantity: { ar: 'يجب أن تكون كل مساهمة رقمًا عشريًا غير سالب بصيغته الدقيقة (بلا مسافات أو إشارة أو أُس أو أصفار بادئة).', en: 'Every designated contribution must be a non-negative decimal in its exact form (no spaces, sign, exponent or leading zeros).' },
  ...
  cn2b_nl_preview_reason: { ar: 'المبرر', en: 'Justification' },
  cn2b_nl_preview_stale: { ar: 'تغيّر التحديد أو المراجعة بعد فتح هذه المعاينة، فلن يُنفَّذ ما تعرضه. لم يُكتب شيء — حدّث المعاينة وراجعها قبل التأكيد.', en: 'The selection or the revision changed after this preview was opened, so what it shows will not be executed. Nothing was written — refresh the preview and check it before confirming.' },
  cn2b_nl_preview_refresh: { ar: 'تحديث المعاينة', en: 'Refresh this preview' },
  cn2b_nl_error_title: { ar: 'رفض الخادم التغيير:', en: 'The server refused the change:' },
  /* C5 §14 (UI-F2) — a multi-line confirmation writes one need line per call; say exactly what was saved before a refusal. */
  cn2b_nl_error_title_unconfirmed: { ar: 'تعذّر تأكيد نتيجة التغيير:', en: 'The outcome of the change could not be confirmed:' },
  cn2b_nl_partial_saved: { ar: 'حُفظ __K__ من __N__ من سطور الاحتياج في هذا التأكيد قبل أن يرفض الخادم السطر التالي، وتبقى تلك السطور محفوظة. الرفض أدناه يخصّ ذلك السطر التالي، ولم يُرسَل شيء بعده.', en: '__K__ of __N__ need lines in this confirmation were saved before the server refused the next one, and those saved lines remain. The refusal below applies to that next line; nothing after it was sent.' },
  /* C5 §13/§14/§15 — override chain availability, stale pins and the pins a write carries. */
  cn2b_nl_block_overrides_unavailable: { ar: 'التعديلات المسجّلة غير محمّلة بالكامل — ينتظر الحفظ اكتمال تحميلها.', en: 'The recorded overrides are not completely loaded — saving waits until they are.' },
  cn2b_nl_block_stale_pin: { ar: 'مساهمة مثبَّتة على تعديل لم يعد التعديل الحالي لخليتها — اختر من جديد.', en: 'A contribution is pinned to an override that is no longer its cell’s current one — choose again.' },
  cn2b_nl_overrides_unavailable: { ar: 'التعديلات المسجّلة غير محمّلة بالكامل. يبقى كل شيء ظاهرًا، لكن لا يمكن حفظ أي سطر احتياج حتى يكتمل تحميلها.', en: 'The recorded overrides are not completely loaded. Everything stays visible, but no need line can be saved until they are.' },
  cn2b_nl_stale_pins_cleared: { ar: 'اعتمدت __N__ مساهمة على تعديل لم يعد التعديل الحالي لخليتها. أُزيل التثبيت وقيمته — اختر التعديل الحالي من جديد أو أدخل المساهمة.', en: '__N__ contribution(s) relied on an override that is no longer the current one for its cell. The pin and its value were cleared — choose the current override again or enter the contribution.' },
  ...
  cn2b_nl_line_sources: { ar: 'خلايا مصدرية', en: 'Source cells' },
  cn2b_nl_override_in_lineage: { ar: 'بتعديل مسجّل', en: 'override applied' },
  cn2b_nl_delete_line_label: { ar: 'السطر المُصحَّح', en: 'Line being corrected' },
  cn2b_nl_delete_sources_affected: { ar: 'روابط المصادر التي ستُزال', en: 'Source links to be removed' },
  cn2b_submit: { ar: 'تقديم للمراجعة', en: 'Submit for review' },
  cn2b_approve: { ar: 'اعتماد', en: 'Approve' },
  cn2b_reject: { ar: 'رفض', en: 'Reject' },
  cn2b_reject_reason_prompt: { ar: 'سبب الرفض:', en: 'Reason for rejection:' },
  cn2b_notice_verified: { ar: 'تم التحقّق وحفظ الأدلة.', en: 'Verified and evidence stored.' },
  cn2b_notice_already_verified: { ar: 'سبق التحقّق من هذا الملف — لم يتغيّر شيء.', en: 'This container was already verified — nothing changed.' },
  cn2b_notice_submitted: { ar: 'تم التقديم للمراجعة.', en: 'Submitted for review.' },
  cn2b_notice_approved: { ar: 'تم الاعتماد.', en: 'Approved.' },
  cn2b_notice_rejected: { ar: 'تم الرفض.', en: 'Rejected.' },
  cn2b_err_forbidden: { ar: 'لا تملك الصلاحية المطلوبة.', en: 'You do not hold the required permission.' },
  cn2b_err_not_authenticated: { ar: 'انتهت الجلسة.', en: 'Your session has ended.' },
  cn2b_err_load_failed: { ar: 'تعذّر تحميل البيانات.', en: 'Could not load the data.' },
  cn2b_err_verify_failed: { ar: 'تعذّر التحقّق الرسمي.', en: 'Authoritative verification failed.' },
  cn2b_err_browser_node_parity_mismatch: { ar: 'اختلفت نتيجة الخادم عن معاينة المتصفح — لم يُحفظ أي دليل.', en: 'The server parse differed from the browser preview — no evidence was stored.' },
  ...
  cn2b_err_source_link_requires_designated_quantity: { ar: 'كل خلية معيّنة تحتاج كمية مساهمتها.', en: 'Every designated cell needs its contribution quantity.' },
  cn2b_err_central_needs_approval_eligibility_changed: { ar: 'لم يُعتمد شيء: مؤسسة مستفيدة أو مخزن هدف في هذا الإصدار لم يعد مؤهلًا. راجع الحالة الحالية للإصدار وجاهزيته.', en: 'Nothing was approved: a beneficiary or target warehouse of this revision is no longer eligible. Review the revision’s current state and readiness.' },
  cn2b_err_central_needs_approval_eligibility_changed__not_found: { ar: 'لم يُعتمد شيء: مؤسسة مستفيدة أو مخزن هدف لسطر احتياج لم يعد موجودًا. راجع الحالة الحالية للإصدار.', en: 'Nothing was approved: a beneficiary institution or target warehouse of a need line no longer exists. Review the revision’s current state.' },
  cn2b_err_central_needs_approval_eligibility_changed__not_care_institution: { ar: 'لم يُعتمد شيء: المستفيد في أحد سطور الاحتياج ليس مؤسسة رعاية. راجع الحالة الحالية للإصدار.', en: 'Nothing was approved: a need line’s beneficiary is not a care institution. Review the revision’s current state.' },
  cn2b_err_central_needs_approval_eligibility_changed__inactive: { ar: 'لم يُعتمد شيء: المؤسسة المستفيدة في أحد سطور الاحتياج لم تعد فعّالة. راجع الحالة الحالية للإصدار.', en: 'Nothing was approved: a need line’s beneficiary institution is no longer active. Review the revision’s current state.' },
  cn2b_err_central_needs_approval_eligibility_changed__archived: { ar: 'لم يُعتمد شيء: أُرشفت المؤسسة المستفيدة في أحد سطور الاحتياج. راجع الحالة الحالية للإصدار.', en: 'Nothing was approved: a need line’s beneficiary institution was archived. Review the revision’s current state.' },
  cn2b_err_central_needs_approval_eligibility_changed__not_owned: { ar: 'لم يُعتمد شيء: مخزن الهدف في أحد سطور الاحتياج لا يتبع المؤسسة المستفيدة. راجع الحالة الحالية للإصدار.', en: 'Nothing was approved: a need line’s target warehouse does not belong to its beneficiary. Review the revision’s current state.' },
  cn2b_err_central_needs_approval_eligibility_changed__not_active: { ar: 'لم يُعتمد شيء: مخزن الهدف في أحد سطور الاحتياج لم يعد فعّالًا. راجع الحالة الحالية للإصدار.', en: 'Nothing was approved: a need line’s target warehouse is no longer active. Review the revision’s current state.' },
  cn2b_err_central_needs_approval_gate_missing: { ar: 'لم يُعتمد شيء: لم يجتز فحص الأمان الخاص بالاعتماد على الخادم. هذا خلل في الخادم — لا تُعد المحاولة، وأبلغ عنه.', en: 'Nothing was approved: the server’s approval safety check did not pass. This is a server-side fault — do not retry; report it.' },
  cn2b_err_beneficiary_organization_archived: { ar: 'أُرشفت هذه المؤسسة المستفيدة ولم يعد ممكنًا أن تُضاف لها سطور احتياج.', en: 'This beneficiary institution was archived and can no longer receive need lines.' },
  cn2b_err_plan_revision_not_submitted: { ar: 'لم يعد هذا الإصدار بانتظار قرار. راجع حالته الحالية.', en: 'This revision is no longer awaiting a decision. Review its current status.' },
  cn2b_err_central_needs_request_failed: { ar: 'تعذّر إكمال الطلب، ولم يمكن التأكد إن كان قد نُفِّذ أم لا. تحقّق من الحالة الحالية قبل إعادة المحاولة.', en: 'The request could not be completed, and whether it took effect could not be confirmed. Check the current state before trying again.' },
  ...
  cn2b_err_state_reread_failed: { ar: 'أكّد الخادم الإجراء، لكن تعذّرت على هذه الشاشة إعادة قراءة الحالة الحالية بعده. قد يكون المعروض قديمًا — أعد تحميل الصفحة لرؤيتها.', en: 'The server confirmed the action, but this screen could not re-read the current state afterwards. What is shown may be out of date — reload the page to see it.' },
  cn2b_err_revision_reread_failed: { ar: 'تعذّرت على هذه الشاشة إعادة قراءة الحالة الحالية لهذا الإصدار. قد يكون المعروض قديمًا — أعد تحميل الصفحة لرؤيتها.', en: 'This screen could not re-read the current state of this revision. What is shown may be out of date — reload the page to see it.' },
  /* C5 §13 (UI-F5) — re-read only the override chain after it could not be read. */
  cn2b_overrides_reload: { ar: 'إعادة قراءة التعديلات', en: 'Reload the overrides' },
  ...
  cn2b_err_beneficiary_column_mapping_in_use: { ar: 'هذا العمود يغذّي سطر احتياج بالفعل ولا يمكن إلغاء تعيينه مباشرة. عند تحويله إلى مناطق يجب أن تبقى كل خلية مرتبطة داخل منطقة لمستفيد سطرها.', en: 'This column already feeds a need line and cannot be unmapped directly. Converting it to regions must keep every linked cell inside a region of its line\'s beneficiary.' },
  ...
  /* C2 — Governed Correction Lifecycle: the control also names the revision
     it corrects, and keeps the "Open next revision" prefix browser tests use. */
  cn2b_open_next_revision_for_year: { ar: 'فتح الإصدار التالي — تصحيح خطة __YEAR__ / الإصدار __N__', en: 'Open next revision — correction of year __YEAR__ / revision __N__' },
  ...
  /* C2 — Governed Correction Lifecycle (M215). A correction keeps the approved
     revision in effect until the correction itself is approved, needs a human
     reason, and follows only the newest revision (stale fence). */
  cn2b_correction_target: { ar: 'تصحيح خطة __YEAR__ / الإصدار __N__.', en: 'Correction of year __YEAR__ / revision __N__.' },
  cn2b_correction_reason_prompt: { ar: 'تصحيح خطة __YEAR__ / الإصدار __N__.\nلماذا يلزم هذا التصحيح؟ (إلزامي)', en: 'Correction of year __YEAR__ / revision __N__.\nWhy is this correction needed? (required)' },
  cn2b_correction_keeps_effective: { ar: 'يبقى الإصدار المعتمد سارياً حتى يُعتمد التصحيح.', en: 'The approved revision stays in effect until the correction is approved.' },
  cn2b_correction_newer_revision_exists: { ar: 'يوجد إصدار أحدث (__N__) لخطة هذه السنة. اختره لفتح تصحيح.', en: 'A newer revision (__N__) exists for this plan year. Select it to open a correction.' },
  cn2b_notice_correction_opened: { ar: 'تم فتح التصحيح كمسودة جديدة. يبقى الإصدار المعتمد سارياً حتى يُعتمد التصحيح.', en: 'Correction opened as a new draft. The approved revision stays in effect until the correction is approved.' },
  cn2b_err_central_needs_revision_stale: { ar: 'فُتح إصدار آخر لخطة هذه السنة بعد الإصدار الذي اخترته. تم تحديث القائمة؛ راجعها وقرّر من جديد.', en: 'Another revision was opened for this plan year after the one you selected. The list has been refreshed — review it and decide again.' },
  cn2b_err_correction_reason_required: { ar: 'يلزم ذكر سبب للتصحيح.', en: 'A correction needs a reason.' },
  cn2b_err_correction_newer_revision_exists: { ar: 'يوجد إصدار أحدث لخطة هذه السنة؛ اختره لفتح تصحيح.', en: 'A newer revision exists for this plan year; select it to open a correction.' },
  cn2b_err_central_needs_governed_correction_required: { ar: 'يجب فتح التصحيح عبر خطوة التصحيح المحكومة.', en: 'A correction must be opened through the governed correction step.' },
  cn2b_err_central_needs_correction_plan_mismatch: { ar: 'الإصدار المحدد لا ينتمي إلى خطة هذه السنة. تم تحديث القائمة.', en: 'The selected revision does not belong to this plan year. The list has been refreshed.' },
  cn2b_err_plan_revision_draft_already_open: { ar: 'توجد مسودة مفتوحة بالفعل لخطة هذه السنة.', en: 'A draft revision is already open for this plan year.' },
  cn2b_err_plan_revision_still_in_review: { ar: 'الإصدار الأحدث ما يزال قيد المراجعة. اعتمده أو ارفضه أولاً.', en: 'The newest revision is still in review. Approve or reject it first.' },
  cn2b_err_central_needs_lifecycle_state_ambiguous: { ar: 'سجل إصدارات خطة هذه السنة غير متسق. لم يتغير شيء؛ راجع مسؤول النظام.', en: 'This plan year\'s revision history is inconsistent. Nothing was changed; contact an administrator.' },
  // C4 (M216) — beneficiary regions.
  cn2b_blocker_beneficiary_region_cell_uncovered: { ar: 'خلية رقمية في عمود تحكمه مناطق مستفيدين لا تقع في أي منطقة — غطّها بمنطقة (مستفيد أو ليست مستفيدًا)، أو اجعل سطرها «غير مطبق» مع السبب', en: 'A numeric cell in a region-governed column lies in no region — cover it with a region (beneficiary or not a beneficiary), or mark its row not applicable with a reason' },
  cn2b_blocker_beneficiary_region_cell_without_need_line: { ar: 'خلية رقمية داخل منطقة مستفيد لا يحملها أي سطر احتياج', en: 'A numeric cell inside a beneficiary region is not carried by any need line' },
  cn2b_blocker_beneficiary_region_overlap: { ar: 'منطقتان فعّالتان في الورقة نفسها تتقاطعان — لا توجد أولوية؛ يجب إزالة التقاطع', en: 'Two active regions of one sheet overlap — there is no precedence; the overlap must be removed' },
  cn2b_blocker_beneficiary_decision_grain_conflict: { ar: 'عمود واحد يحكمه قرار عمود كامل ومناطق مستفيدين معًا — يجب أن يبقى أسلوب واحد فقط', en: 'One column is governed by a whole-column decision and by beneficiary regions at once — only one may remain' },
  cn2b_blocker_beneficiary_region_geometry_invalid: { ar: 'منطقة فعّالة غير صالحة: جلستها غير مكتملة، أو حدودها خارج الإطار، أو لا تحتوي أي خلية مستوردة', en: 'An active region is invalid: its session is not completed, its bounds are out of range, or it contains no imported cell' },
  cn2b_err_beneficiary_region_expected_ids_required: { ar: 'يجب إرسال المجموعة الكاملة لمعرّفات المناطق الفعّالة كما حُمّلت، بلا تكرار ولا قيم فارغة. لم يُكتب شيء.', en: 'The complete set of active region ids as loaded is required, with no duplicate or empty value. Nothing was written.' },
  cn2b_err_beneficiary_region_operation_invalid: { ar: 'تعديل المناطق المرسل غير صالح الشكل. لم يُكتب شيء.', en: 'The region change sent is malformed. Nothing was written.' },
  cn2b_err_beneficiary_region_session_not_in_revision: { ar: 'جلسة الاستيراد لا تنتمي إلى هذه المراجعة. لم يُكتب شيء.', en: 'The import session does not belong to this revision. Nothing was written.' },
  cn2b_err_beneficiary_region_session_not_completed: { ar: 'جلسة الاستيراد غير مكتملة. لم يُكتب شيء.', en: 'The import session is not completed. Nothing was written.' },
  cn2b_err_beneficiary_region_sheet_index_invalid: { ar: 'رقم الورقة غير موجود في الأدلة المستوردة لهذه الجلسة. لم يُكتب شيء.', en: 'This sheet index is not present in the session\'s imported evidence. Nothing was written.' },
  cn2b_err_beneficiary_region_parser_identity_mismatch: { ar: 'الجدول المعروض لم يُرسم بالمحلل الذي استورد هذه الجلسة. لم يُكتب شيء.', en: 'The grid on screen was not rendered by the parser that imported this session. Nothing was written.' },
  cn2b_err_beneficiary_region_sheet_mismatch: { ar: 'اسم الورقة المعروض لا يطابق الورقة المحفوظة. لم يُكتب شيء.', en: 'The sheet name on screen does not match the stored sheet. Nothing was written.' },
  cn2b_err_beneficiary_region_stale: { ar: 'تغيّرت مناطق هذه الورقة (أو قرار العمود) منذ تحميلها. لم يُكتب شيء.', en: 'The regions of this sheet (or a column decision) changed since they were loaded. Nothing was written.' },
  cn2b_err_beneficiary_region_bounds_invalid: { ar: 'حدود المنطقة خارج الإطار المسموح. لم يُكتب شيء.', en: 'The region bounds are out of range. Nothing was written.' },
  cn2b_err_beneficiary_region_decision_invalid: { ar: 'يجب اختيار قرار صريح: مستفيد أو ليست مستفيدًا. لم يُكتب شيء.', en: 'An explicit decision is required: beneficiary or not a beneficiary. Nothing was written.' },
  cn2b_err_beneficiary_region_beneficiary_required: { ar: 'قرار «مستفيد» يتطلب اختيار المؤسسة. لم يُكتب شيء.', en: 'A beneficiary decision requires choosing the institution. Nothing was written.' },
  cn2b_err_beneficiary_region_non_beneficiary_must_not_name_beneficiary: { ar: 'قرار «ليست مستفيدًا» لا يسمّي مؤسسة. لم يُكتب شيء.', en: 'A not-a-beneficiary decision names no institution. Nothing was written.' },
  cn2b_err_beneficiary_region_unknown: { ar: 'المنطقة المستهدفة ليست منطقة فعّالة في هذه الورقة. لم يُكتب شيء.', en: 'The target is not an active region of this sheet. Nothing was written.' },
  cn2b_err_beneficiary_region_no_matching_evidence: { ar: 'لا تحتوي المنطقة أي خلية مستوردة. لم يُكتب شيء.', en: 'The region contains no imported cell. Nothing was written.' },
  cn2b_err_beneficiary_region_duplicate: { ar: 'هذه الحدود مكررة في الطلب أو مطابقة لمنطقة فعّالة. لتغيير القرار على الحدود نفسها استخدم «استبدال». لم يُكتب شيء.', en: 'These bounds repeat in the request or equal an active region. To change a decision on the same bounds, use replace. Nothing was written.' },
  cn2b_err_beneficiary_region_conversion_requires_region: { ar: 'تحويل عمود إلى مناطق يتطلب منطقة جديدة واحدة على الأقل ترسمها أنت فوقه. لا يُنسخ شيء من قرار العمود. لم يُكتب شيء.', en: 'Converting a column to regions needs at least one new region you draw over it. Nothing is copied from the column decision. Nothing was written.' },
  cn2b_err_beneficiary_region_overlap: { ar: 'المناطق في الورقة نفسها قد تتلامس لكنها لا تشترك في خلية. لم يُكتب شيء.', en: 'Regions of one sheet may touch but never share a cell. Nothing was written.' },
  cn2b_err_beneficiary_region_column_already_decided: { ar: 'هذا العمود له قرار عمود كامل. حوّله إلى مناطق صراحةً في الطلب نفسه، أو أبقه كما هو. لم يُكتب شيء.', en: 'This column has a whole-column decision. Convert it to regions explicitly in the same request, or keep it. Nothing was written.' },
  cn2b_err_beneficiary_region_in_use: { ar: 'خلية تغذي سطر احتياج ستفقد منطقة مستفيدها أو تغيّرها. احذف ذلك السطر مع السبب أولًا، ثم أعد تعيين الخلايا بعد التغيير. لم يُكتب شيء.', en: 'A cell feeding a need line would lose or change its beneficiary region. Delete that line with a reason first, then re-designate the cells after the change. Nothing was written.' },
  cn2b_err_beneficiary_region_lineage_invalid: { ar: 'سلسلة إصدارات المنطقة غير متسقة. لم يُكتب شيء.', en: 'The region\'s version lineage is inconsistent. Nothing was written.' },
  cn2b_err_beneficiary_region_required: { ar: 'عمود هذه الخلية تحكمه مناطق مستفيدين، ولا توجد منطقة فعّالة تغطيها.', en: 'This cell\'s column is governed by beneficiary regions, and no active region covers it.' },
  cn2b_err_beneficiary_region_not_beneficiary: { ar: 'هذه الخلية في منطقة رُوجعت على أنها ليست مستفيدًا — لا تغذي سطر احتياج.', en: 'This cell lies in a region reviewed as not a beneficiary — it never feeds a need line.' },
  cn2b_err_beneficiary_region_mapping_conflict: { ar: 'منطقة هذه الخلية الفعّالة تخص مستفيدًا آخر.', en: 'This cell\'s active region belongs to another beneficiary.' },
  cn2b_err_beneficiary_region_version_immutable: { ar: 'إصدارات المناطق لا تُعدَّل ولا تُحذف؛ يُسمح فقط بإيقافها مرة واحدة مع السبب.', en: 'Region versions are never edited or deleted; they can only be retired once, with a reason.' },
  cn2b_err_beneficiary_decision_grain_conflict: { ar: 'هذا العمود تحكمه مناطق مستفيدين؛ لا يمكن أن يحمل قرار عمود كامل في الوقت نفسه.', en: 'This column is governed by beneficiary regions; it cannot hold a whole-column decision at the same time.' },
  cn2b_err_beneficiary_regions_read_inconsistent: { ar: 'تعذّر تحميل مناطق المستفيدين بشكل متسق. العرض فقط إلى أن تنجح إعادة التحميل.', en: 'The beneficiary regions could not be loaded consistently. View only until a reload succeeds.' },
  cn2b_err_beneficiary_regions_not_loaded: { ar: 'لم تُحمَّل مناطق المستفيدين بعد.', en: 'The beneficiary regions are not loaded yet.' },
  cn4_region_title: { ar: 'مناطق المستفيدين المحفوظة', en: 'Saved beneficiary regions' },
  cn4_region_hint: { ar: 'ما يحفظه الخادم لهذه الورقة يظهر منفصلًا عن مسوداتك غير المحفوظة. يُحمَّل دائمًا من الخادم.', en: 'What the server holds for this sheet is shown apart from your unsaved drafts. It is always reloaded from the server.' },
  cn4_region_loading: { ar: 'جارٍ تحميل المناطق المحفوظة…', en: 'Loading saved regions…' },
  cn4_region_unavailable: { ar: 'المناطق المحفوظة غير متاحة — التعديل معطّل', en: 'Saved regions are unavailable — editing is disabled' },
  cn4_region_g3_read_only: { ar: 'الجدول المعروض لم يُرسم بالمحلل الذي استورد هذا الملف؛ المناطق للعرض فقط.', en: 'The grid on screen was not rendered by the parser that imported this file; regions are view only.' },
  cn4_region_saved_title: { ar: 'المحفوظ على الخادم', en: 'Saved on the server' },
  cn4_region_empty: { ar: 'لا توجد منطقة محفوظة في هذه الورقة.', en: 'No saved region on this sheet.' },
  cn4_region_beneficiary: { ar: 'مستفيد', en: 'Beneficiary' },
  cn4_region_non_beneficiary: { ar: 'ليست مستفيدًا', en: 'Not a beneficiary' },
  cn4_region_version: { ar: 'الإصدار __N__', en: 'version __N__' },
  cn4_region_remove: { ar: 'إزالة', en: 'Remove' },
  cn4_region_replace_with_selection: { ar: 'استبدال بالتحديد الحالي', en: 'Replace with the current selection' },
  cn4_region_m213_title: { ar: 'أعمدة لها قرار عمود كامل', en: 'Columns with a whole-column decision' },
  cn4_region_m213_read_only: { ar: 'قرار عمود كامل (للعرض هنا)', en: 'whole-column decision (view only here)' },
  cn4_region_convert: { ar: 'تحويل إلى مناطق', en: 'Convert to regions' },
  cn4_region_convert_cancel: { ar: 'إلغاء التحويل', en: 'Cancel conversion' },
  cn4_region_converting_hint: { ar: 'ارسم بنفسك كل منطقة فوق هذا العمود واختر مستفيد كل منها. لا يُنسخ شيء من قرار العمود.', en: 'Draw every region over this column and choose each beneficiary yourself. Nothing is copied from the column decision.' },
  cn4_region_unsaved_title: { ar: 'مصادر احتياج غير محفوظة', en: 'Unsaved Need sources' },
  cn4_region_unsaved_empty: { ar: 'لا توجد مسودة غير محفوظة.', en: 'No unsaved draft.' },
  cn4_region_unsaved_badge: { ar: 'غير محفوظة', en: 'unsaved' },
  cn4_region_obstacle_REGION_OVERLAP: { ar: 'تتقاطع مع منطقة محفوظة', en: 'overlaps a saved region' },
  cn4_region_obstacle_M213_COLUMN: { ar: 'تقع على عمود له قرار عمود كامل — حوّله إلى مناطق أولًا', en: 'lies on a column with a whole-column decision — convert it to regions first' },
  cn4_region_conversion_needs_region: { ar: 'عمود قيد التحويل لا تغطيه بعد أي منطقة جديدة ترسمها أنت.', en: 'A column being converted is not yet covered by any new region you drew.' },
  cn4_region_save_drafts: { ar: 'حفظ كمناطق', en: 'Save as regions' },
  cn4_region_mark_non_beneficiary: { ar: 'تعيين التحديد «ليست مستفيدًا»', en: 'Mark the selection as not a beneficiary' },
  cn4_region_inverse: { ar: 'إعادة العمود إلى قرار عمود كامل', en: 'Return the column to a whole-column decision' },
  cn4_region_inverse_hint: { ar: 'ستُوقف مناطق هذا العمود. يبقى العمود غير محسوم — ويمنع الجاهزية — إلى أن يُتخذ قرار عمود كامل في مراجعة المؤسسات.', en: 'The regions over this column will be retired. The column stays unresolved — and blocks readiness — until a whole-column decision is made in the institution review.' },
  cn4_region_inverse_multi_column: { ar: 'منطقة تمتد على عدة أعمدة تغطي هذا العمود. ضيّقها أولًا عبر «استبدال».', en: 'A region spanning several columns covers this column. Narrow it first with replace.' },
  cn4_region_decision_label: { ar: 'القرار', en: 'Decision' },
  cn4_region_choose_beneficiary: { ar: 'المؤسسة المستفيدة', en: 'Beneficiary institution' },
  cn4_region_reason_label: { ar: 'السبب (إلزامي)', en: 'Reason (required)' },
  cn4_region_confirm: { ar: 'تأكيد', en: 'Confirm' },
  cn4_region_saved: { ar: 'حُفظت المناطق.', en: 'Regions saved.' },
  cn4_region_stale_reloaded: { ar: 'أُعيد التحميل من الخادم — راجع وقرّر من جديد.', en: 'Reloaded from the server — review and decide again.' },
  cn4_region_governed_column: { ar: 'هذا العمود تحكمه مناطق مستفيدين — لا قرار عمود كامل هنا', en: 'This column is governed by beneficiary regions — no whole-column decision here' },
  cn4_m213_keeps_column_out_of_regions: { ar: 'قرار العمود الكامل يُبقي العمود خارج مناطق المستفيدين إلى أن يُحوَّل صراحةً في عرض المصنف.', en: 'A whole-column decision keeps the column out of beneficiary regions until it is explicitly converted on the workbook view.' },
  cn4_one_click_suppressed: { ar: 'التأكيد بنقرة واحدة غير متاح: العمود يتقاطع مع منطقة أو مسودة مرسومة على المصنف.', en: 'One-click confirmation is unavailable: the column intersects a region or a draft drawn on the workbook.' },
  cn4_effective_ambiguous: { ar: 'المراجعة النافذة: غامضة — أكثر من مراجعة معتمدة، لا يُعلَّم شيء نافذًا', en: 'Effective revision: ambiguous — more than one approved revision, nothing is marked effective' },
  cn4_effective_revision: { ar: 'المراجعة النافذة (المعتمدة): المراجعة __N__ — للعرض فقط', en: 'Effective (approved) revision: revision __N__ — display only' },
  cn4_effective_none: { ar: 'لا توجد مراجعة معتمدة نافذة بعد', en: 'No approved revision is in effect yet' },
  cn2b_err_expected_latest_revision_id_required: { ar: 'لم يُحدَّد الإصدار الذي يُفتح التصحيح بعده.', en: 'The revision this correction follows was not specified.' },
  cn2b_err_central_needs_plan_not_found: { ar: 'لا توجد خطة لهذه السنة.', en: 'No plan exists for this year.' },
  cn2b_err_rejection_reason_required: { ar: 'يلزم ذكر سبب للرفض.', en: 'A rejection needs a reason.' },
  cn2b_history_title: { ar: 'سجل إصدارات خطة __YEAR__', en: 'Revision history of the __YEAR__ plan' },
  cn2b_history_show: { ar: 'عرض سجل الإصدارات', en: 'Show revision history' },
  cn2b_history_refresh: { ar: 'تحديث سجل الإصدارات', en: 'Refresh revision history' },
  cn2b_history_loading: { ar: 'جارٍ تحميل السجل…', en: 'Loading history…' },
  cn2b_history_empty: { ar: 'لا يوجد سجل لهذه الخطة بعد.', en: 'No history for this plan yet.' },
  cn2b_history_open: { ar: 'فُتح الإصدار __N__', en: 'Revision __N__ opened' },
  cn2b_history_open_correction: { ar: 'فُتح الإصدار __N__ كتصحيح بعد الإصدار __AFTER__', en: 'Revision __N__ opened as a correction after revision __AFTER__' },
  cn2b_history_submit: { ar: 'قُدّم الإصدار __N__ للمراجعة', en: 'Revision __N__ submitted for review' },
  cn2b_history_approve: { ar: 'اعتُمد الإصدار __N__', en: 'Revision __N__ approved' },
  cn2b_history_approve_replaces: { ar: 'اعتُمد الإصدار __N__ وحلّ محل الإصدار __PREV__', en: 'Revision __N__ approved, replacing revision __PREV__' },
  cn2b_history_reject: { ar: 'رُفض الإصدار __N__', en: 'Revision __N__ rejected' },
  cn2b_history_supersede: { ar: 'حلّ الإصدار __BY__ محل الإصدار __N__', en: 'Revision __N__ superseded by revision __BY__' },
  cn2b_history_reason: { ar: 'السبب: __REASON__', en: 'Reason: __REASON__' },
  ...
  cn2b_override: { ar: 'تصحيح', en: 'Override' },
  cn2b_override_replace: { ar: 'تعديل التصحيح', en: 'Replace override' },
  cn2b_override_kind: { ar: 'نوع القيمة', en: 'Value kind' },
  cn2b_override_value: { ar: 'القيمة المعتمدة', en: 'Final value' },
  cn2b_override_reason: { ar: 'السبب (إلزامي)', en: 'Reason (required)' },
  cn2b_override_note: { ar: 'ملاحظة (اختياري)', en: 'Note (optional)' },
  cn2b_override_save: { ar: 'حفظ التصحيح', en: 'Save override' },
  cn2b_cancel: { ar: 'إلغاء', en: 'Cancel' },
  cn2b_kind_number: { ar: 'رقم', en: 'Number' },
  cn2b_kind_text: { ar: 'نص', en: 'Text' },
  cn2b_kind_boolean: { ar: 'منطقي', en: 'Boolean' },
  cn2b_kind_blank: { ar: 'فارغ', en: 'Blank' },
  cn2b_err_number_required: { ar: 'أدخل رقمًا صالحًا — لن تُحوَّل القيمة تلقائيًا.', en: 'Enter a valid number — nothing is coerced for you.' },
  cn2b_err_boolean_required: { ar: 'اختر true أو false.', en: 'Choose true or false.' },
  cn2b_err_override_failed: { ar: 'تعذّر حفظ التصحيح.', en: 'Could not save the override.' },
  /* C5 §13/§15 — the override chain read state and the numeric override confirmation. */
  cn2b_err_override_number_not_canonical: { ar: 'أدخل الرقم بصيغته الدقيقة: أرقام، ثم نقطة وأرقام اختياريًا — بلا مسافات أو إشارات أو أسس أو أصفار بادئة، وبحد أقصى 256 حرفًا.', en: 'Enter the number in its exact form: digits, optionally one point followed by digits — no spaces, signs, exponents or leading zeros, at most 256 characters.' },
  cn2b_override_read_unavailable: { ar: 'التعديلات المسجّلة غير مقروءة بالكامل، لذلك لا تُعرض قيمة معتمدة ولا يمكن تسجيل تعديل الآن.', en: 'The recorded overrides are not completely read, so no effective value is shown and no override can be recorded right now.' },
  cn2b_effective_unknown: { ar: 'غير معروفة — التعديلات غير محمّلة', en: 'Unknown — overrides not loaded' },
  cn2b_override_number_grammar: { ar: 'بالصيغة الدقيقة فقط: أرقام، ثم نقطة وأرقام اختياريًا — بلا مسافات أو إشارة أو أُس أو أصفار بادئة.', en: 'Exact form only: digits, optionally one point and digits — no spaces, sign, exponent or leading zeros.' },
  cn2b_override_text_not_numeric: { ar: 'القيمة النصية لا تُحسب أبدًا تعديلًا رقميًا للكمية.', en: 'A text value never counts as a numeric quantity override.' },
  cn2b_override_number_preview: { ar: 'معاينة الرقم الذي سيُخزَّن', en: 'Preview the stored number' },
  cn2b_override_number_confirm: { ar: 'تأكيد وتسجيل هذا الرقم', en: 'Confirm and record this number' },
  cn2b_override_number_will_store: { ar: 'سيُخزَّن رقم JSON هذا بالضبط:', en: 'This exact JSON number will be stored:' },
  cn2b_override_number_not_exact: { ar: 'هذا ليس الرقم العشري الذي كتبته بالضبط — لا تستطيع JavaScript تمثيله. تحقّق منه قبل التأكيد.', en: 'This is not exactly the decimal you typed — JavaScript cannot hold it. Check it before confirming.' },
  cn2b_panel_source_search: { ar: 'بحث في الأدلة المصدرية', en: 'Source evidence search' },
  ...
  inv_tab_return_exceptions: { ar: 'استثناءات مرتجعات المنافذ', en: 'Return exceptions' },
  ...
  mv_return_exceptions_title: { ar: 'استثناءات مرتجعات عالقة',                    en: 'Stuck return exceptions' },
  mv_return_exceptions_none: { ar: 'لا توجد استثناءات بانتظار الحل',              en: 'No exceptions awaiting resolution' },
  mv_resolution_confirmed_no_stock: { ar: 'تأكيد عدم وصول أي كمية',               en: 'Confirm nothing arrived' },
  mv_resolution_corrected_receipt:  { ar: 'تصحيح: وصلت كمية فعلًا',               en: 'Correct: a quantity actually arrived' },
  mv_resolve_exception:   { ar: 'حل الاستثناء',                                   en: 'Resolve exception' },
  mv_exception_already_resolved: { ar: 'تم حل هذا الاستثناء مسبقًا',              en: 'This exception was already resolved' },
  mv_exception_reason_required: { ar: 'سبب الحل مطلوب',                          en: 'A resolution reason is required' },
  mv_exception_quantity_invalid: { ar: 'الكمية المصححة غير صالحة',                en: 'The corrected quantity is invalid' },
  ...
  mv_f_resolution_kind:   { ar: 'نوع الحل',                                      en: 'Resolution type' },
  mv_f_corrected_quantity: { ar: 'الكمية المصححة',                               en: 'Corrected quantity' },
  mv_f_resolution_reason: { ar: 'سبب الحل',                                      en: 'Resolution reason' },
  ...
  /* C5 §17 — the closed card's own sentence for each terminal status (approved keeps cn2b_simple_already_approved). */
  cn2b_simple_closed_submitted: { ar: 'قُدِّم هذا الاحتياج وينتظر قرار الاعتماد. لا يمكن تعديله، ولا يُفتح تصحيح إلا بعد اعتماده أو رفضه.', en: 'This annual need was submitted and awaits an approval decision. It cannot be edited, and a correction can only follow once it is approved or rejected.' },
  cn2b_simple_closed_rejected: { ar: 'رُفض هذا الاحتياج وأُغلق. للمتابعة، أنشئ نسخة تصحيح جديدة.', en: 'This annual need was rejected and is closed. To continue, create a new correction revision.' },
  cn2b_simple_closed_superseded: { ar: 'حلّت محلّ هذه النسخة نسخةٌ معتمدة أحدث. يُحتفظ بها سجلًا — افتح أحدث نسخة للمتابعة.', en: 'A newer approved revision replaced this one. It is kept as history — open the newest revision to continue.' },
  ...
  // ── E1 Excel-First — read-only original workbook viewer ───────────────────
  // Presentation labels only. The viewer shows parser evidence verbatim; none
  // of these words names a parser concept an everyday user would not know.
  cn2b_xl_title:                     { ar: 'معاينة الملف الأصلي', en: 'Original file preview' },
  cn2b_xl_read_only:                 { ar: 'للقراءة فقط', en: 'Read-only' },
  cn2b_xl_note:                      { ar: 'يُعرض الملف كما قرأه المتصفح، دون أي تعديل أو احتساب. هذه المعاينة للاطلاع فقط ولا يُحفظ منها شيء.', en: 'The file is shown exactly as your browser read it, with nothing changed or calculated. This preview is for reference only and saves nothing.' },
  cn2b_xl_workbook:                  { ar: 'الملف داخل الأرشيف', en: 'File in the archive' },
  cn2b_xl_workbook_unreadable:       { ar: 'تعذّرت قراءة هذا الملف، لذلك لا يمكن عرض محتواه.', en: 'This file could not be read, so its content cannot be shown.' },
  cn2b_xl_workbook_unreadable_short: { ar: 'تعذّرت قراءته', en: 'unreadable' },
  cn2b_xl_no_workbooks:              { ar: 'لا يحتوي الأرشيف على ملفات Excel يمكن عرضها.', en: 'The archive contains no Excel files that can be shown.' },
  cn2b_xl_sheets:                    { ar: 'الأوراق', en: 'Sheets' },
  cn2b_xl_sheet_hidden:              { ar: 'ورقة مخفية', en: 'Hidden sheet' },
  cn2b_xl_sheet_very_hidden:         { ar: 'ورقة مخفية بالكامل', en: 'Very hidden sheet' },
  cn2b_xl_sheet_visible:             { ar: 'ورقة ظاهرة', en: 'Visible sheet' },
  cn2b_xl_sheet_hidden_notice:       { ar: 'هذه الورقة مخفية في الملف الأصلي، وتُعرض هنا للاطلاع فقط.', en: 'This sheet is hidden in the original file and is shown here for reference only.' },
  ...
  cn2b_xl_file:                      { ar: 'الملف', en: 'File' },
  cn2b_xl_fingerprint:               { ar: 'بصمة الملف (SHA-256)', en: 'File fingerprint (SHA-256)' },
  cn2b_xl_state:                     { ar: 'الحالة', en: 'Status' },
  cn2b_xl_raw_value:                 { ar: 'القيمة الأصلية', en: 'Original value' },
  cn2b_xl_value_type:                { ar: 'نوع القيمة', en: 'Value type' },
  cn2b_xl_formatted:                 { ar: 'القيمة المنسقة', en: 'Formatted value' },
  cn2b_xl_formula:                   { ar: 'الصيغة', en: 'Formula' },
  cn2b_xl_formula_cached_note:       { ar: 'القيمة الأصلية المعروضة هي النتيجة المحفوظة في الملف.', en: 'The original value shown is the result saved in the file.' },
  cn2b_xl_error:                     { ar: 'الخطأ', en: 'Error' },
  cn2b_xl_comment:                   { ar: 'التعليق', en: 'Comment' },
  cn2b_xl_merged:                    { ar: 'خلايا مدمجة', en: 'Merged cells' },
  cn2b_xl_merged_hidden_values:      { ar: 'داخل النطاق المدمج __N__ قيمة أخرى لا يعرضها Excel:', en: 'Inside the merged range, __N__ other value(s) are not shown by Excel:' },
  cn2b_xl_merged_scan_limited:       { ar: 'تم إيقاف فحص القيم الإضافية بعد __N__ خلية محفوظة للحفاظ على استجابة الواجهة. قد توجد قيم أخرى داخل النطاق ولم يتم تقدير عددها.', en: 'The extra-value check stopped after __N__ stored cells to keep the viewer responsive. More values may exist inside the range; their number was not estimated.' },
  cn2b_xl_merge_display_limited:     { ar: 'تم تقييد عرض __N__ من نطاقات الدمج غير الآمنة أو الزائدة من أصل __TOTAL__ مع بقاء معلومات الملف الأصلية محفوظة.', en: 'The viewer safely limited __N__ unsafe or excess merged range(s) out of __TOTAL__; the original file information remains unchanged.' },
  cn2b_xl_merge_outside_used_area:   { ar: 'يوجد __N__ من نطاقات الدمج خارج المنطقة المستخدمة من الورقة، فلا توجد خلايا لعرضها ضمنها؛ معلومات الملف الأصلية تبقى محفوظة.', en: '__N__ merged range(s) lie outside the used area of the sheet, so there are no cells to show for them; the original file information remains unchanged.' },
  cn2b_xl_audit:                     { ar: 'تفاصيل التدقيق', en: 'Audit details' },
  cn2b_xl_presence_value:            { ar: 'تحتوي على قيمة', en: 'Has a value' },
  cn2b_xl_presence_blank:            { ar: 'خلية موجودة بلا قيمة', en: 'Cell exists, no value' },
  cn2b_xl_presence_missing:          { ar: 'لا توجد خلية في الملف', en: 'No cell in the file' },
  cn2b_xl_type_number:               { ar: 'رقم', en: 'Number' },
  cn2b_xl_type_string:               { ar: 'نص', en: 'Text' },
  cn2b_xl_type_boolean:              { ar: 'صح أو خطأ', en: 'True or false' },
  cn2b_xl_type_date:                 { ar: 'تاريخ', en: 'Date' },
  cn2b_xl_type_error:                { ar: 'خطأ في الخلية', en: 'Cell error' },
  /* E2-B — Sheet Mapping Profile: the human declares column roles; nothing is inferred. */
  cn2b_map_title:                    { ar: 'تعيين أدوار أعمدة الورقة', en: 'Sheet mapping profile' },
  cn2b_map_eyebrow:                  { ar: 'مسودة على هذه الشاشة فقط — لا تُحفظ', en: 'Draft on this screen only — not saved' },
  cn2b_map_lead:                     { ar: 'حدّد العمود الذي يحتوي على الرمز الوطني والعمود الذي يحتوي على المادة في هذه الورقة. القرار لك: لا يُستنتج أي شيء من محتوى العمود أو عنوانه أو موقعه.', en: 'Tell MediStock which column of this sheet holds the National Code and which holds the Material. You decide: nothing is guessed from a column\'s contents, its header or its position.' },
  cn2b_map_unavailable:              { ar: 'افتح الملف الأصلي الموثّق أعلاه وحدّد عموداً بالنقر على حرفه أو بالضغط على Ctrl+Space. يتاح التعيين فقط عندما تثبت هوية مصدر الملف.', en: 'Open the verified original workbook above and select a column — click its letter or press Ctrl+Space. Mapping is available only when the workbook\'s source identity is proven.' },
  cn2b_map_selected:                 { ar: 'التحديد الحالي', en: 'Current selection' },
  cn2b_map_column:                   { ar: 'العمود __COL__', en: 'Column __COL__' },
  cn2b_map_cell:                     { ar: 'الخلية __REF__', en: 'Cell __REF__' },
  cn2b_map_range:                    { ar: 'النطاق __REF__', en: 'Range __REF__' },
  cn2b_map_column_required:          { ar: 'لتعيين دور، حدّد عموداً كاملاً (انقر على حرفه أو اضغط Ctrl+Space). لا يمكن استخدام خلية أو نطاق.', en: 'To assign a role, select a whole column (click its letter or press Ctrl+Space). A cell or a range cannot be used.' },
  cn2b_map_roles:                    { ar: 'الأدوار المعيّنة', en: 'Assigned roles' },
  cn2b_map_role_national_code:       { ar: 'الرمز الوطني', en: 'National Code' },
  cn2b_map_role_material:            { ar: 'المادة', en: 'Material' },
  cn2b_map_not_assigned:             { ar: 'غير معيّن', en: 'Not assigned' },
  cn2b_map_actions:                  { ar: 'تعيين العمود المحدد', en: 'Assign the selected column' },
  cn2b_map_use_national_code:        { ar: 'استخدام العمود __COL__ للرمز الوطني', en: 'Use column __COL__ as National Code' },
  cn2b_map_use_material:             { ar: 'استخدام العمود __COL__ للمادة', en: 'Use column __COL__ as Material' },
  cn2b_map_use_national_code_idle:   { ar: 'استخدام للرمز الوطني', en: 'Use as National Code' },
  cn2b_map_use_material_idle:        { ar: 'استخدام للمادة', en: 'Use as Material' },
  cn2b_map_clear:                    { ar: 'إلغاء التعيين', en: 'Clear' },
  cn2b_map_clear_label:              { ar: 'إلغاء تعيين عمود __ROLE__ (العمود __COL__)', en: 'Clear the __ROLE__ column (column __COL__)' },
  cn2b_map_done_assigned:            { ar: 'أصبح العمود __COL__ عمود __ROLE__.', en: 'Column __COL__ is now the __ROLE__ column.' },
  cn2b_map_done_cleared:             { ar: 'لم يعد عمود __ROLE__ معيّناً.', en: 'The __ROLE__ column is no longer assigned.' },
  cn2b_map_done_reset:               { ar: 'أُلغي تعيين الدورين.', en: 'Both roles are unassigned.' },
  cn2b_map_err_conflict:             { ar: 'العمود __COL__ معيّن بالفعل كعمود __OTHER__. لا يمكن لعمود واحد أن يحمل الدورين — ألغِ تعيينه أولاً. لم يتغيّر شيء.', en: 'Column __COL__ is already the __OTHER__ column. One column cannot hold both roles — clear it first. Nothing was changed.' },
  cn2b_map_err_not_column:           { ar: 'حدّد عموداً كاملاً أولاً — لا يمكن لخلية أو نطاق أن يحمل دوراً. لم يتغيّر شيء.', en: 'Select a whole column first — a cell or a range cannot hold a role. Nothing was changed.' },
  cn2b_map_err_refused:              { ar: 'تعذّر تعيين هذا العمود لأن مصدره أو ورقته لا يطابقان التحديد الموثّق. لم يتغيّر شيء.', en: 'This column could not be assigned because its source or sheet does not match the verified selection. Nothing was changed.' },
  cn2b_inst_title:                    { ar: 'ربط المؤسسات بمصادر الاحتياج', en: 'Institution Need mapping' },
  cn2b_inst_lead:                     { ar: 'لكل مؤسسة في هذه الورقة: حدّد الخلية التي يظهر فيها اسمها، ثم عمود احتياجها أو نطاقه، ثم اختر المؤسسة من قائمة MediStock. لا يُستنتج أي شيء من نص الملف، ولا تُقرأ أي كمية.', en: 'For each institution on this sheet: select the cell that shows its name, then its Need column or range, then choose the institution from MediStock\'s list. Nothing is guessed from the workbook\'s text, and no quantity is read.' },
  cn2b_inst_unavailable:              { ar: 'افتح الملف الأصلي الموثّق أعلاه وحدّد خلية أو عموداً. يتاح ربط المؤسسات فقط عندما تثبت هوية مصدر الملف.', en: 'Open the verified original workbook above and select a cell or a column. Institution mapping is available only when the workbook\'s source identity is proven.' },
  cn2b_inst_editor_new:               { ar: 'ربط مؤسسة جديدة', en: 'New institution mapping' },
  cn2b_inst_editor_edit:              { ar: 'تعديل ربط مؤسسة', en: 'Edit institution mapping' },
  cn2b_inst_part_anchor:              { ar: 'خلية اسم المؤسسة في الملف', en: 'Institution name cell in the workbook' },
  cn2b_inst_part_need:                { ar: 'مصدر كميات الاحتياج', en: 'Need quantities source' },
  cn2b_inst_part_beneficiary:         { ar: 'المؤسسة المستفيدة (من قائمة MediStock)', en: 'Beneficiary institution (from MediStock\'s list)' },
  cn2b_inst_not_set:                  { ar: 'لم يُحدَّد بعد', en: 'Not set yet' },
  cn2b_inst_use_anchor:               { ar: 'استخدام __SEL__ كخلية اسم المؤسسة', en: 'Use __SEL__ as the institution name cell' },
  cn2b_inst_use_anchor_idle:          { ar: 'استخدام التحديد كخلية اسم المؤسسة', en: 'Use the selection as the institution name cell' },
  cn2b_inst_use_need:                 { ar: 'استخدام __SEL__ لكميات الاحتياج', en: 'Use __SEL__ for the Need quantities' },
  cn2b_inst_use_need_idle:            { ar: 'استخدام التحديد لكميات الاحتياج', en: 'Use the selection for the Need quantities' },
  cn2b_inst_choose:                   { ar: 'اختر مؤسسة…', en: 'Choose an institution…' },
  cn2b_inst_no_beneficiaries:         { ar: 'لا توجد مؤسسات رعاية فعّالة متاحة للاختيار، لذلك لا يمكن إكمال الربط.', en: 'No active care institutions are available to choose from, so no mapping can be completed.' },
  cn2b_inst_add:                      { ar: 'إضافة الربط', en: 'Add mapping' },
  cn2b_inst_apply:                    { ar: 'تطبيق التعديل', en: 'Apply changes' },
  cn2b_inst_cancel_edit:              { ar: 'إلغاء التعديل', en: 'Cancel editing' },
  cn2b_inst_clear_draft:              { ar: 'مسح هذه الاختيارات', en: 'Clear these choices' },
  cn2b_inst_list_title:               { ar: 'المؤسسات المربوطة (__N__)', en: 'Mapped institutions (__N__)' },
  cn2b_inst_list_empty:               { ar: 'لم تُربط أي مؤسسة بعد.', en: 'No institution is mapped yet.' },
  cn2b_inst_item_anchor:              { ar: 'خلية الاسم', en: 'Name cell' },
  cn2b_inst_item_need:                { ar: 'الاحتياج', en: 'Need' },
  cn2b_inst_item_valid:               { ar: 'الربط سليم', en: 'Mapping is valid' },
  cn2b_inst_item_problem:             { ar: 'الربط يحتاج إلى مراجعة', en: 'Mapping needs attention' },
  cn2b_inst_edit:                     { ar: 'تعديل', en: 'Edit' },
  cn2b_inst_edit_label:               { ar: 'تعديل ربط __NAME__', en: 'Edit the mapping for __NAME__' },
  cn2b_inst_remove:                   { ar: 'إزالة', en: 'Remove' },
  cn2b_inst_remove_label:             { ar: 'إزالة ربط __NAME__', en: 'Remove the mapping for __NAME__' },
  cn2b_inst_reset:                    { ar: 'إعادة تعيين ربط المؤسسات', en: 'Reset institution mappings' },
  cn2b_inst_reset_question:           { ar: 'إزالة جميع ربوط المؤسسات (__N__) من هذه المسودة؟ يبقى عمودا الرمز الوطني والمادة كما هما، ولا يتغيّر الملف.', en: 'Remove all __N__ institution mappings from this draft? The National Code and Material columns stay as they are, and the workbook is not changed.' },
  cn2b_inst_reset_yes:                { ar: 'نعم، أزل الكل', en: 'Yes, remove all' },
  cn2b_inst_reset_keep:               { ar: 'الإبقاء عليها', en: 'Keep them' },
  cn2b_inst_done_anchor:              { ar: 'خلية اسم المؤسسة الآن: __SEL__.', en: 'The institution name cell is now __SEL__.' },
  cn2b_inst_done_need:                { ar: 'مصدر كميات الاحتياج الآن: __SEL__.', en: 'The Need quantities source is now __SEL__.' },
  cn2b_inst_done_added:               { ar: 'رُبطت المؤسسة __NAME__.', en: '__NAME__ is now mapped.' },
  cn2b_inst_done_updated:             { ar: 'عُدّل ربط __NAME__.', en: 'The mapping for __NAME__ is updated.' },
  cn2b_inst_done_removed:             { ar: 'أُزيل ربط __NAME__.', en: 'The mapping for __NAME__ is removed.' },
  cn2b_inst_done_editing:             { ar: 'جارٍ تعديل ربط __NAME__.', en: 'Editing the mapping for __NAME__.' },
  cn2b_inst_done_cleared:             { ar: 'مُسحت الاختيارات؛ لم يتغيّر أي ربط.', en: 'The choices were cleared; no mapping was changed.' },
  cn2b_inst_done_reset:               { ar: 'أُزيلت ربوط المؤسسات من المسودة (__N__). بقي عمودا الرمز الوطني والمادة كما هما.', en: 'All __N__ institution mappings were removed from the draft. The National Code and Material columns are unchanged.' },
  cn2b_inst_nothing_changed:          { ar: 'لم يتغيّر شيء.', en: 'Nothing was changed.' },
  cn2b_inst_unknown_org:              { ar: 'مؤسسة غير موجودة في القائمة الحالية (__ID__)', en: 'Institution not in the current list (__ID__)' },
  cn2b_inst_merged:                   { ar: '(مدمجة __REF__)', en: '(merged __REF__)' },
  cn2b_inst_sel_cell:                 { ar: 'الخلية __REF__', en: 'cell __REF__' },
  cn2b_inst_sel_range:                { ar: 'النطاق __REF__', en: 'range __REF__' },
  cn2b_inst_sel_column:               { ar: 'العمود __COL__', en: 'column __COL__' },
  cn2b_inst_why_no_selection:         { ar: 'لا يوجد تحديد موثّق في الملف.', en: 'There is no verified selection in the workbook.' },
  cn2b_inst_why_invalid:              { ar: 'التحديد أو الربط غير صالح.', en: 'The selection or mapping is not valid.' },
  cn2b_inst_why_source:               { ar: 'التحديد من ملف آخر غير الملف المعروض.', en: 'The selection belongs to another workbook.' },
  cn2b_inst_why_sheet:                { ar: 'التحديد من ورقة أخرى.', en: 'The selection belongs to another sheet.' },
  cn2b_inst_why_anchor_kind:          { ar: 'لا يمكن لعمود كامل أن يكون خلية اسم مؤسسة؛ حدّد خلية أو نطاقاً.', en: 'A whole column cannot be an institution name cell; select a cell or a range.' },
  cn2b_inst_why_need_kind:            { ar: 'لا يمكن لخلية واحدة أن تكون مصدر احتياج؛ حدّد عموداً كاملاً أو نطاقاً.', en: 'A single cell cannot be a Need source; select a whole column or a range.' },
  cn2b_inst_why_incomplete:           { ar: 'حدّد الأجزاء الثلاثة: خلية الاسم، ومصدر الاحتياج، والمؤسسة المستفيدة.', en: 'Set all three parts: the name cell, the Need source and the beneficiary institution.' },
  cn2b_inst_why_not_eligible:         { ar: 'المؤسسة ليست في قائمة مؤسسات الرعاية الفعّالة الحالية.', en: 'The institution is not in the current list of active care institutions.' },
  cn2b_inst_why_profile:              { ar: 'أدوار الأعمدة (الرمز الوطني والمادة) تخص ورقة أخرى.', en: 'The column roles (National Code and Material) belong to another sheet.' },
  cn2b_inst_why_national_code:        { ar: 'مصدر الاحتياج يشمل عمود الرمز الوطني.', en: 'The Need source includes the National Code column.' },
  cn2b_inst_why_material:             { ar: 'مصدر الاحتياج يشمل عمود المادة.', en: 'The Need source includes the Material column.' },
  cn2b_inst_why_duplicate:            { ar: 'هذا الربط نفسه موجود بالفعل.', en: 'This exact mapping already exists.' },
  cn2b_inst_why_need_overlap:         { ar: 'مصدر الاحتياج يتداخل مع مصدر احتياج __NAME__.', en: 'The Need source overlaps the Need source of __NAME__.' },
  cn2b_inst_why_anchor_in_own_need:   { ar: 'خلية الاسم تقع داخل نطاق الاحتياج نفسه؛ حدّد نطاقاً لا يشملها.', en: 'The name cell lies inside its own Need range; select a range that does not include it.' },
  cn2b_inst_why_anchor_overlap:       { ar: 'خلية الاسم هي أيضاً خلية اسم مؤسسة أخرى: __NAME__.', en: 'The name cell is also the name cell of another institution: __NAME__.' },
  cn2b_inst_why_anchor_in_need:       { ar: 'خلية الاسم تقع داخل نطاق احتياج __NAME__.', en: 'The name cell lies inside the Need range of __NAME__.' },
  cn2b_inst_why_need_covers_anchor:   { ar: 'نطاق الاحتياج يشمل خلية اسم __NAME__.', en: 'The Need range covers the name cell of __NAME__.' },
  cn2b_inst_why_unknown:              { ar: 'هذا الربط لم يعد موجوداً.', en: 'This mapping no longer exists.' },
  cn2b_approve_title:                 { ar: 'مراجعة تعيينات الملف واعتمادها محليًا', en: 'File mapping review and local approval' },
  cn2b_approve_disclaimer:            { ar: 'هذا الاعتماد يثبت مراجعة التعيينات فقط ولا يرسل الخطة للاعتماد.', en: 'This approval covers mapping review only and does not submit or approve the Annual Needs revision.' },
  cn2b_approve_state_blocked:         { ar: 'الحالة: محجوب — لا يمكن اعتماد التعيينات بعد.', en: 'Status: BLOCKED — the mappings cannot be approved yet.' },
  cn2b_approve_state_valid:           { ar: 'الحالة: صالح — التعيينات جاهزة للمراجعة والاعتماد المحلي.', en: 'Status: VALID — the mappings are ready for review and local approval.' },
  cn2b_approve_state_approved:        { ar: 'الحالة: صالح — تعيينات الملف معتمدة محليًا.', en: 'Status: VALID — file mappings approved locally.' },
  cn2b_approve_checklist:             { ar: 'قائمة التحقق', en: 'Checklist' },
  cn2b_approve_check_revision:        { ar: 'مسودة الاحتياج السنوي محددة', en: 'Annual Needs draft identified' },
  cn2b_approve_check_source:          { ar: 'مصدر Excel موثوق', en: 'Trusted Excel source' },
  cn2b_approve_check_national_code:   { ar: 'عمود الرمز الوطني محدد', en: 'National Code column assigned' },
  cn2b_approve_check_material:        { ar: 'عمود المادة محدد', en: 'Material column assigned' },
  cn2b_approve_check_institutions:    { ar: 'المؤسسات مرتبطة', en: 'Institutions mapped' },
  cn2b_approve_check_no_conflict:     { ar: 'لا يوجد تعارض', en: 'No conflicts' },
  cn2b_approve_check_no_unsaved_edit: { ar: 'لا يوجد تعديل غير محفوظ', en: 'No unsaved edit' },
  cn2b_approve_met:                   { ar: 'متحقق', en: 'Done' },
  cn2b_approve_not_met:               { ar: 'غير متحقق', en: 'Not yet' },
  cn2b_approve_blockers:              { ar: 'ما يلزم قبل الاعتماد', en: 'What is needed before approval' },
  cn2b_approve_block_revision:        { ar: 'لا توجد مسودة احتياج سنوي محددة لهذا الملف.', en: 'No Annual Needs draft is identified for this workbook.' },
  cn2b_approve_block_context:         { ar: 'افتح الملف الأصلي الموثّق أعلاه وحدّد خلية أو عموداً فيه.', en: 'Open the verified original workbook above and select a cell or a column in it.' },
  cn2b_approve_block_profile:         { ar: 'تعيين أدوار الأعمدة غير صالح؛ عيّن الأدوار من جديد.', en: 'The column-role mapping is not valid; assign the roles again.' },
  cn2b_approve_block_national_code:   { ar: 'عيّن عمود الرمز الوطني في «تعيين أدوار أعمدة الورقة».', en: 'Assign the National Code column in the sheet mapping profile.' },
  cn2b_approve_block_material:        { ar: 'عيّن عمود المادة في «تعيين أدوار أعمدة الورقة».', en: 'Assign the Material column in the sheet mapping profile.' },
  cn2b_approve_block_same_column:     { ar: 'عمود الرمز الوطني وعمود المادة هما العمود نفسه.', en: 'The National Code and Material columns are the same column.' },
  cn2b_approve_block_context_mismatch: { ar: 'أدوار الأعمدة وربوط المؤسسات تخصّ ورقتين مختلفتين.', en: 'The column roles and the institution mappings belong to different sheets.' },
  cn2b_approve_block_no_institutions: { ar: 'أضف ربط مؤسسة واحدة على الأقل.', en: 'Add at least one institution mapping.' },
  cn2b_approve_block_invalid_mapping: { ar: 'أحد ربوط المؤسسات غير صالح.', en: 'An institution mapping is not valid.' },
  cn2b_approve_block_not_eligible:    { ar: 'إحدى المؤسسات المربوطة لم تعد في قائمة مؤسسات الرعاية الفعّالة.', en: 'A mapped institution is no longer in the list of active care institutions.' },
  cn2b_approve_block_conflict:        { ar: 'يوجد تعارض في ربوط المؤسسات؛ راجع الربوط التي تحتاج إلى مراجعة.', en: 'The institution mappings have a conflict; check the mappings that need attention.' },
  cn2b_approve_block_draft:           { ar: 'أنهِ ربط المؤسسة الجاري أو امسح اختياراته.', en: 'Finish the institution mapping in progress or clear its choices.' },
  cn2b_approve_block_reset_pending:   { ar: 'أكّد إعادة تعيين ربط المؤسسات أو ألغِها.', en: 'Confirm or cancel the pending reset of institution mappings.' },
  cn2b_approve_awaiting:              { ar: 'التعيينات صالحة وتنتظر اعتمادك المحلي الصريح.', en: 'The mappings are valid and await your explicit local approval.' },
  cn2b_approve_fingerprinting:        { ar: 'جارٍ حساب بصمة SHA-256 للدليل…', en: 'Computing the SHA-256 evidence fingerprint…' },
  cn2b_approve_fingerprint_unavailable: { ar: 'تعذّر حساب بصمة SHA-256 في هذا المتصفح، لذلك لا يمكن الاعتماد المحلي.', en: 'The SHA-256 fingerprint cannot be computed in this browser, so local approval is not possible.' },
  cn2b_approve_fingerprint:           { ar: 'بصمة الدليل (SHA-256):', en: 'Evidence fingerprint (SHA-256):' },
  cn2b_approve_action:                { ar: 'اعتماد تعيينات الملف', en: 'Approve file mappings' },
  cn2b_approve_approved_locally:      { ar: 'تعيينات الملف معتمدة محليًا', en: 'File mappings approved locally' },
  cn2b_approve_nothing_sent:          { ar: 'لم يُرسل أي شيء إلى الخادم، ولم تُرسل خطة الاحتياج السنوي أو تُعتمد.', en: 'Nothing was sent to the server; the Annual Needs revision was not submitted or approved.' },
  cn2b_approve_stale:                 { ar: 'لم يعد الاعتماد المحلي السابق مطابقاً للتعيينات الحالية. راجعها واعتمدها من جديد.', en: 'The earlier local approval no longer matches the current mappings. Review and approve them again.' },
  cn2b_approve_evidence:              { ar: 'الدليل القانوني (JSON) الذي تغطيه البصمة', en: 'Canonical evidence (JSON) covered by the fingerprint' },
};

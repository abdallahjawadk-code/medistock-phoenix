      ...
      {availableOptions.length === 0 ? (
        ...
        <>
          ...
          <div style={{ marginBottom: '12px' }}>
            ...
            {amountInvalid && (
              <p style={{ fontSize: '11px', color: 'var(--err)', marginTop: '4px' }}>
                <PhoenixIcon name="warning" size={14} style={{ verticalAlign: 'text-bottom', marginInlineEnd: '5px' }} /> {t(isPositiveOnly ? 'mvmt_amount_err_positive' : 'mvmt_amount_err_non_negative', lang)}
              </p>
            )}
          </div>
          ...
          <div style={{ marginBottom: '12px' }}>
            ...
            />
            {reasonMissing && (
              <p style={{ fontSize: '11px', color: 'var(--err)', marginTop: '4px' }}><PhoenixIcon name="warning" size={13} style={{ verticalAlign: 'text-bottom', marginInlineEnd: '4px' }} />{t('mvmt_reason_required_err', lang)}</p>
            )}
          </div>
          ...
          {previewNegative && (
            <p style={{ fontSize: '11.5px', color: 'var(--err)', textAlign: 'center', marginBottom: '10px' }}>
              <PhoenixIcon name="warning" size={14} style={{ verticalAlign: 'text-bottom', marginInlineEnd: '5px' }} /> {t('mvmt_preview_negative_err', lang)}
            </p>
          )}

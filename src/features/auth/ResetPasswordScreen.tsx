  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', position: 'relative' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '22px' }}>
        <div style={{ width: '64px', height: '64px', borderRadius: 'var(--r4)', background: 'var(--phoenix-gold, var(--p))', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', color: 'var(--phoenix-gold-ink)' }}><PhoenixIcon name="lock" size={30} /></div>
      ...
      <div style={{ width: '100%', maxWidth: '375px', background: 'var(--s)', borderRadius: 'var(--r5)', boxShadow: 'var(--sh-xl)', padding: '26px', border: '1px solid var(--brd)' }}>
        {state === 'done' ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <button onClick={onBackToLogin} style={{ width: '100%', padding: '13px', borderRadius: 'var(--r3)', border: 'none', background: 'var(--phoenix-gold, var(--p))', color: 'var(--phoenix-gold-ink)', fontSize: '14px', fontWeight: 700, cursor: 'pointer' }}>
          ...
          <form onSubmit={onSubmit}>
            ...
            <button type="submit" disabled={busy} style={{ width: '100%', padding: '14px', borderRadius: 'var(--r3)', border: 'none', background: 'var(--phoenix-gold, var(--p))', color: 'var(--phoenix-gold-ink)', fontSize: '15px', fontWeight: 700, cursor: busy ? 'wait' : 'pointer', opacity: busy ? 0.7 : 1, boxShadow: '0 12px 26px color-mix(in srgb, var(--phoenix-gold, var(--p)) 30%, transparent)' }}>

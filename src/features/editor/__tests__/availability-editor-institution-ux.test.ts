...
describe('AVAILABILITY-EDITOR-NATIONAL-CODE-WIRING-A: no SQL/migration/package side effects', () => {
  it('no migration 056 (or higher) exists (052/053/054/055 are later, separately-reviewed QR-EFFECTIVE-CONDITION-QUANTITY-ZERO-052-A / DB-REMOVED-OUTLET-MATERIAL-MARKER-053-A / PHASE2-DASHBOARD-PERFORMANCE-RPCS-054-A / PHASE3-DEEP-CLEAN-AVAILABILITY-DATA-A additions)', () => {
    const migsDir = join(PHOENIX, 'supabase/migrations');
